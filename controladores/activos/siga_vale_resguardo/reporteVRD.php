    ...
    <table id="tbl" border cellpadding="10"  cellspacing="0">
      ...
      <tbody class="tbody">
        <tr style="background:#bcbbbb;" id="tr">          
		  		<td class="td text-center" style="width: 10%">AF/BC</td>
          <td class="td text-center" style="width: 30%">Activo</td>
					<td class="td text-center" style="width: 14%">Serie</td>
					<td class="td text-center" style="width: 10%">Marca</td>
					<td class="td text-center" style="width: 10%">Modelo</td>					
          <td class="td text-center" style="width: 10%">Area</td>
          <td class="td text-center" style="width: 15%">Valor reposición</td>          
        </tr>
		<?php 
		...
		?>
				<tr id="tr">				  
				  <td class="td"><?php if($Respuesta["data_Detalle"][$i]["AF_BC"]!=null){echo $Respuesta["data_Detalle"][$i]["AF_BC"];} ?></td>
				  <td class="td"><?php if($Respuesta["data_Detalle"][$i]["Nombre_Activo"]!=null){echo $Respuesta["data_Detalle"][$i]["Nombre_Activo"];} ?></td>
				  <td class="td"><?php if($Respuesta["data_Detalle"][$i]["NumSerie"]!=null){echo $Respuesta["data_Detalle"][$i]["NumSerie"];} ?></td>
					<td class="td"><?php if($Respuesta["data_Detalle"][$i]["Nom_Area"]!=null){echo $Respuesta["data_Detalle"][$i]["Nom_Area"];} ?></td>				  
				  <td class="td"><?php if($Respuesta["data_Detalle"][$i]["Fech_Inser"]!=null){echo substr($Respuesta["data_Detalle"][$i]["Fech_Inser"], 0, 10);} ?></td>
				  <td class="td"><?php if($Respuesta["data_Detalle"][$i]["Estatus_Activo"]!='3'){echo "Activo";}else{echo "Baja";}?></td>
					<td class="td">10,590.00</td>
				</tr>
		<?php
			}
		}
