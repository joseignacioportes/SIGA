...
<page backtop="35mm" backbottom="5mm" backleft="1mm" backright="1mm" orientation="portrait">
	...
	<table id="tbl" style="width: 100%;">
		<tr id="tr">
			...
			<td class="td" style="width: 33.3%;" align="center"><h3>Mantenimiento<br/>Predictivo</h3></td>
		...
		if($contador_img>0){
			...
			for($m=0;$m<$contador_img;$m++){
				...
				if($extension[1]=="png"||$extension[1]=="jpg"||$extension[1]=="jpeg"||$extension[1]=="gif"){
					$tablafotolabel.='		<img src="../../../Archivos/Archivos-Actividades/Mantenimiento-Predictivo/'.$array_fotos[$m].'" width="260" height="260">';
				}else{
					$tablafotolabel.='		<a href="../../../Archivos/Archivos-Actividades/Mantenimiento-Predictivo/'.$array_fotos[$m].'" target="_blank">Descargar '.$extension[1].'</a>';
				}
				...
				//$tablafotolabel.='<td class="td" style="width: 50%;"><div align="center"><img src="../../../Archivos/Archivos-Actividades/Mantenimiento-Predictivo/'.$array_fotos[$m].'" width="260" height="260"></div><br><div style="text-align:center;background:#f4f4f4;font-size: 11px;">Foto '.$contadoradjuntos_img.'</div></td>';
