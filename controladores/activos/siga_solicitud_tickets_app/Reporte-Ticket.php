			...
			<tr id="tr">
			  <td class="td sign" style="width: 50%;">
				<?php if($Firma_Base64!=""){?>
					...
					<br>FIRMADO  POR:<br>
					<?php if($Respuesta["data"][0]["Usuario"]!=null){echo htmlentities($Respuesta["data"][0]["Usuario"]);}  ?>
					<br>
					<?php if($Respuesta["data"][0]["Fech_Cierre"]!=null){echo htmlentities($Respuesta["data"][0]["Fech_Cierre"]);} ?>
				<?php }else{
					echo "Firma<br><br><br><br><br><br>FIRMADO DIGITALMENTE POR:<br>";
					if($Respuesta["data"][0]["Usuario"]!=null){echo htmlentities($Respuesta["data"][0]["Usuario"]);}
					echo "<br>";
					if($Respuesta["data"][0]["Fech_Cierre"]!=null){echo htmlentities($Respuesta["data"][0]["Fech_Cierre"]);}
				}?></td>
			  <td class="td sign" style="width: 50%;">
					Firma	<br><br><br><br><br><br>FIRMADO DIGITALMENTE POR:<br>
					<?php if($Respuesta["data"][0]["Gestor"]!=null){echo htmlentities($Respuesta["data"][0]["Gestor"]);}  ?>
					<br>
					<?php if($Respuesta["data"][0]["Fech_Inser"]!=null){echo htmlentities($Respuesta["data"][0]["Fech_Seguimiento"]);} ?>
			  </td>
			</tr>
			<tr id="tr">
