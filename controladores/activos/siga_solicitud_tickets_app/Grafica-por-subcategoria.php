...
<page backtop="35mm" backbottom="5mm" backleft="1mm" backright="1mm" orientation="portrait">
	...
	<table id="tbl" style="width: 100%;">
		<tr id="tr">
			...
			<td class="td" style="width: 33.3%;" align="center"></td>
  ...
  <!-- /.login-logo -->
	...
	<div align="center"><?php echo "<strong>Fecha Inicial: </strong> "; echo $Fech_In;echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong> Fecha Final: </strong> "; echo $Fech_Fin;?></div>
