...
(function (factory) {
    ...
    tModalMain = '<div id="' + MODAL_ID + '"  data-backdrop="false" class="file-zoom-dialog modal fade" tabindex="-1" aria-labelledby="' +
        MODAL_ID + 'Label"></div>';
    ...
    FileInput.prototype = {
        ...
        _getZoomButton: function (type) {
            var self = this, label = self.previewZoomButtonIcons[type], css = self.previewZoomButtonClasses[type],
				...
				params = title + (type === 'close' ? ' onclick="cerrar_ventana_archivos()" aria-hidden="true"' : '');
