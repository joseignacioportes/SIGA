...
<script>
 ...
 $("#btnBuscar").click(function(e){
	 e.preventDefault();
	 loadOptionBandejas('reportepoliza.php?Id_Menu=5&Id_Submenu=1035&Anio='+$("#cmbAnio").val()+'&Mes='+$("#cmbMes").val()+'&Agrupar='+$('#cmbAgrupar').val()+'&INPCPeriodo='+$("#cmbINPC").val(),'contenedorprincipalactivofijo','818'); 
 });
