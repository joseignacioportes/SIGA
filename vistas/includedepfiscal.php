...
<?php 
 ...
 $obj = new SIGA(); 
 $anios = $obj->obtenFiscal($AFBCPOST,"");
 ...
 $resultado = $obj->obtenFiscal($AFBCPOST,$Anio); 
?>
     <div class="modal fade modalchs" data-backdrop="false" id="periodo-fiscal">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header azuldef">
            <button type="button" class="close"  aria-label="Close" id="botonClosePopupFiscal">
              <span aria-hidden="true">&times;</span>
            </button>
            <h4 class="modal-title">Depreciación periodo / Fiscal</h4>
          </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                            <input type="email"class="form-control text-right" value="Linea Recta" id="FechaConsultar" placeholder="">
                            </div>
                        </div>
	...
	function cerrarPop()
	{
		$("#periodo-fiscal").remove();
		//$("#botonClosePopupFiscal").click();
	}
	$("#cmbAnioFiscal").change(function(e)
	{
		//alert('Hola');
		//$("#periodo-fiscal").modal('hide');
		$("#botonClosePopupFiscal").click();
	...
	$("#botonClosePopupFiscal").click(function(e){
		$("#periodo-fiscal").remove();
	});
	</script>