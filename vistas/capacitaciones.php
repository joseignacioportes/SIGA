...
<link rel="stylesheet" href="../dist/css/jquery-confirm.min.css">
  <script src="../dist/css/jquery-confirm.min.js"></script>
    <!-- File Input -->
          ...
          <!-- Button trigger modal -->
            <a href="#" data-toggle="modal" data-target="#Actividades_Activo_Fijo" onclick="limpiar()" id="abrir_popup">
              ...
              <div class="info-box-content">
                <h3 class="info-box-text">Nueva Capacitación</h3>
              </div>
              <!-- /.info-box-content -->
            </a>
          </div>
              ...
              <div class="row">
                <div class="col-md-10 col-md-offset-1">
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      <div class="form-group">
						<label  class="control-label" style="font-size: 11px;">Título Capacitaci&oacute;n</label>
                        <input rows="2" class="form-control" placeholder="Título Capacitaci&oacute;n" id="txt_Rutina_Search">
                      </div>
                    </div>
                  ...
                  <div class="row" align="center">
                    <button type="button" class="btn chs" id="btn_buscar_full_calendar" onclick="busqueda_full_calendar(4)">Buscar</button>
  ...
  <!-- /.content-wrapper -->
    ...
    <div class="modal fade modalchs" id="Actividades_Activo_Fijo">
            ...
            <div class="row">
                 <div class="col-md-10 col-md-offset-1">
                     <div class="col-md-4">
                         <div class="form-group">
							<span><font color="red">*</font></span>
							<label for="cmbareas" class="control-label" id="cmbareasLabel" style="font-size: 11px;">T&iacute;tulo Capacitaci&oacute;n</label>
                            <textarea rows="1" class="form-control" placeholder="Titulo Capacitacion" id="txt_Nombre_Rutina"></textarea>
                         </div>
						 <div class="form-group" style="display:none">
							 <ul class="inline">
                     ...
                     <div class="col-md-4">
                         <div class="form-group">
							<label for="cmbareas" class="control-label" id="cmbareasLabel" style="font-size: 11px;">Desc. Corta</label>
...
<script>
  ...
  $(document).ready(function(){
	url_direccion="../Archivos/Archivos-Actividades/Capacitaciones";
	Estatus_Tipo_Actividad=4;
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	guardar=function(){
		...
		if (Nombre_Rutina.length<= 0) {
			Agregar = false; 
			mensaje_error += " -Falta agregar el Titulo de la Capacitacion <br />";
		}
			...
			$.ajax({
				...
				success: function (data) {
					...
					if(data.totalCount>0){
						...
						//				Vincular_Mesa_de_Ayuda("4",data.Actividades_Det[i].Id_Actividad,data.Actividades_Det[i].Id_Det_Actividad,data.Actividades_Det[i].Nombre_Actividad, data.Actividades_Det[i].Valor_Referencia, Descripcion_Det, Id_Activo, Usuario_Sistem_Activo, Nombre_Rutina,data.Frecuencia,Descripcion);
						//			}
						//		}
						//	}
						//}
	...
	limpiar=function(){
        ...
        contenido+='      <input type="text" class="form-control" placeholder="" style="font-size: 11px;" id="Num_Actividad0" value="1" disabled>';
		contenido+='    </div>';
        contenido+='  </td>';
        contenido+='  <td>';
		...
		contenido+='	</div>';
		contenido+='	<input type="text" class="form-control pull-right datepicker" style="font-size: 11px;" onclick="Cambio_Fecha_Progr_Array(0)" id="fecha_programada0">';
		contenido+='  </div>';
		contenido+='</td>';
		contenido+='<td>';
		contenido+='  <div class="input-group date">';
		...
		contenido+='	  <i class="fa fa-calendar"></i>';
		contenido+='	</div>';
		contenido+='	<input type="text" class="form-control pull-right datepicker" style="font-size: 11px;" onclick="Cambio_Fecha_Reali_Array(0)" id="fecha_realizada0" disabled>';
		contenido+='  </div>';
		contenido+='</td>';
        contenido+='  <td><span><i class="fa fa-trash" aria-hidden="true" onclick="quitarmas(0)" id="quitarmas_table_dinamyc0"></i></span></td>';
        contenido+='</tr>';
                ...
                success: function (data) {
					...
					if(estatus==1 || estatus==3){
						...
						for(var i=0;i < data.totalCountDetalle; i++){
							...
							contenido+='      <input type="text" class="form-control" placeholder="" style="font-size: 11px;" id="Num_Actividad'+i+'" value='+data.data_det[i].Num_Actividad.trim()+' disabled>';
							contenido+='    </div>';
							contenido+='  </td>';
							contenido+='  <td>';
							contenido+='    <div class="form-group">';
							...
							if(estatus!=2){
								...
								if(data.data_det[i].Url_Adjunto!=null && data.data_det[i].Url_Adjunto!=""){
									contenido+='<a href="../Archivos/Archivos-Actividades/Capacitaciones/'+data.data_det[i].Url_Adjunto+'" target="_blank">Ver Im&aacute;gen</a>';
								}
								contenido+='	  </div>';
							}
							contenido+='    </div>';
							...
							contenido+='	  <i class="fa fa-calendar"></i>';
							contenido+='	</div>';
							contenido+='	<input type="text" class="form-control pull-right datepicker" style="font-size: 11px;" onclick="Cambio_Fecha_Progr_Array('+i+')" id="fecha_programada'+i+'" value="'+Fecha_Prog+'">';
							contenido+='  </div>';
							contenido+='</td>';
							contenido+='<td>';
							contenido+='  <div class="input-group date">';
							...
							contenido+='	  <i class="fa fa-calendar"></i>';
							contenido+='	</div>';
							contenido+='	<input type="text" class="form-control pull-right datepicker" style="font-size: 11px;" onclick="Cambio_Fecha_Reali_Array('+i+')" id="fecha_realizada'+i+'" disabled value="'+Fecha_Real+'">';
							contenido+='  </div>';
							contenido+='</td>';
							contenido+='  <td>';
							if(Estatus_check<=0){
