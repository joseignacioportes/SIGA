...
input[class="super-sad03"]:focus + svg {
  ...
  <input type="hidden" id="No_Empleado_chat">
	...
	<link href="/siga/dist/css/spinner.css" rel="stylesheet">
...
<div class="row">
	...
	<div class="col-md-3 col-sm-6 col-xs-12">
		<div class="info-box azul">
			...
			<a href="#" data-toggle="modal" data-target="#ticket_asistencia_especial" onclick="limpiarcamposasistenciaesp()">
				<span class="info-box-icon bg-aqua"><i class="fa fa-arrow-circle-o-up"></i></span>
				<div class="info-box-content">
					<h3 class="info-box-text">Asistencia Especial</h3>
				</div>
			</a>
	...
	<ul class="nav nav-tabs azulf" role="tablist">
		<li role="presentation" id="li_tab_nuevos" class="active">
			<span class="label label-warning" id="notificacion_nuevos_t" style="display:none"></span>
			<a onclick="cargar_tablas();" href="#inventario" aria-controls="inventario" role="tab" data-toggle="tab" id="tabNuevas">Nuevas</a>
		</li>
		<li role="presentation" id="li_tab_seguimiento">
			<span class="label label-success" id="notificacion_seguimiento_t" style="display:none"></span>
			<a onclick="cargar_tablas()" href="#altas" aria-controls="altas" role="tab" data-toggle="tab"  id="tabSeguimiento">Seguimiento</a>
		</li>
		<li role="presentation" id="li_tab_por_cerrar">
			<a onclick="cargar_tablas()" href="#porcerrar" aria-controls="porcerrar" role="tab" data-toggle="tab"  id="tabPorcerrar">Por Calificar</a>
		</li>
      ...
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-header azuldef">
            ...
            <h4 class="modal-title"><i class="fa fa-check-circle-o" aria-hidden="true"></i>Tickets(679)</h4>
          </div>
               ...
               <div class="col-md-10 col-md-offset-1">
                 <div class="col-md-5">
                   <ul class="heads">
											...
											<input type="button" class="btn btn-primary" value="Enviar Pre registro" onclick="ver_preregistro()" style="display: inline-block; display: none;" id="enviar_prer_egistro" >
						...
						<div id="datos_actividades"></div>
							...
							<input type='hidden' id='act_fch_operacion' name='act_fch_operacion' readonly>
								<table class="table table-striped table-bordered" id="lista_actividades_rutinas" width="100%">
									<thead>
										<tr>	
											<td align="center" style="width:3%">Doc <br> Ref</td>
											...
											<td align="center"><p id="sigaContadorActividades" name="sigaContadorActividades"></p></td>
										</tr>
									</thead>
	...
	<div class="row">
		...
		<div class="container-fluid">
			<div class="col-md-12">
				...
				<div class="modal-body">
					<div class="table-responsive">
						<table class="table table-striped table-bordered" width="100%">
							<thead>
								<tr>
									<td style="width: 35%;">Materiales Almacén</td>
						...
						<table class="table table-striped table-bordered" width="100%">
							<thead>
								<tr>
									...
									<td style="width: 10%;"><span id="totalImporteMateriales"></span>					
								</td>
								</tr>
							</thead>
						</table>
				...
				<div class="modal-footer">
					<center>
						<button type="button" class="btn btn-success btn-sm" id="btnModalAlmacen">+ Material Almacén</button>
						<button type="button" class="btn btn-success btn-sm" id="btnModalExterno">+ Material Externo (1123)</button>
					</center>
				</div> 
    ...
    <div role="tabpanel" class="tab-pane" id="cerrar">
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          <div class="col-md-5">
							<ul class="heads">
								<li><span>No. Solicitud de ayuda: </span> <span style="color: #666;font-weight: normal;" id="spanNumsolicitud3"></span></li>
...
<div class="modal fade modalchs" data-backdrop="false" id="modalAccesorios">
		<div class="modal-dialog">
			...
			<div class="modal-content">
			  <div class="modal-header azuldef">
					...
					<h4 class="modal-title"><i class="fa fa-check-circle-o" aria-hidden="true"></i> Editar Accesorio <label id="id_materiales"></label> </h4>
				</div>
				...
				<div class="modal-body nopsides">
									...
									<table class="table table-striped">
										<tbody>
											<tr>
												...
												<td><p id="acc_descripcion_material"></p></td>
											</tr>
											<tr>
												<td>Sku:</td>
												<td><p id="acc_sku_material"></p></td>
											</tr>
											<tr>
												<td>Clase:</td>
												<td><p id="acc_clase_material"></p></td>
											</tr>
											<tr>
												<td>Unidad:</td>
												<td><p id="acc_unidad_material"></p></td>
											</tr>
											<tr>
												<td>Costo:</td>
												<td><p id="acc_costo_material"></p></td>
											</tr>
											<tr>
												<td>Folio Almacen:</td>
												<td><input type="text" name="acc_folio_almacen_material" id="acc_folio_almacen_material" class="form-control"></td>
											</tr>
											<tr>
												<td>Cantidad:</td>
												<td>
													<input type="text" name="acc_cantidad_material" id="acc_cantidad_material" class="form-control">
													<!-- <input type="number" name="acc_cantidad_material" id="acc_cantidad_material" class="form-control" min="0" step="1" value="0" onkeydown="return false;"> -->
												</td>
											</tr>
										</tbody>
									</table>
					...
					<div class="tab-content">
							<div class="modal-footer">
							<button type="button" id="acc_actualizarAccesorio" onclick="editarMaterialUpdate();" class="btn btn-success">+ Actualizar</button>							
							</div>
					</div>
				</div>
		  </div>
...
<div class="modal fade modalchs" data-backdrop="false" id="modalAccesoriosAlta">
		<div class="modal-dialog">
			<input type="hidden" id="hdd_Id_Solicitud">
			<input type="hidden" id="hdd_Id_Actividad">
			<div class="modal-content">
			  <div class="modal-header azuldef">
					...
					<h4 class="modal-title"><i class="fa fa-check-circle-o" aria-hidden="true"></i> Agregar Accesorio </label> </h4>
				</div>
				...
				<div class="modal-body nopsides">
									...
									<table class="table table-striped" style="width: 100%;">
										<tbody>
											<tr>
												<td>Descripción Material:</td>
												<td style="width: 75%;">
													<select name="combo_accesorios_assist" id="combo_accesorios_assist"></select>										
												</td>
											</tr>
											<tr>
												<td>Sku:</td>
												<td><p id="acc_sku_material_a"></p></td>
											</tr>
											<tr>
												<td>Clase:</td>
												<td><p id="acc_clase_material_a"></p></td>
											</tr>
											<tr>
												<td>Unidad:</td>
												<td><p id="acc_unidad_material_a"></p></td>
											</tr>
											<tr>
												<td>Localización:</td>
												<td><p id="acc_localizacion_a"></p></td>
											</tr>
											<tr>
												<td>Existencia:</td>
												<td><p id="acc_existencia_a"></p></td>
											</tr>
											<tr>
												<td>Costo:</td>
												<td><p id="acc_costo_material_a"></p><p id="acc_costo_material_a_costo" style="display: none;"></p></td>
											</tr>
											<tr>
												<td>Folio Almacen:</td>
												<td><input type="text" name="acc_folio_almacen_material_a" id="acc_folio_almacen_material_a" class="form-control input-sm"></td>
											</tr>
											<tr>
												<td>Cantidad</td>
												<td>
													<input type="text" name="acc_cantidad_material_a" id="acc_cantidad_material_a" class="form-control">
												</td>
											</tr>
										</tbody>
									</table>
					...
					<div class="tab-content">
							<div class="modal-footer">
							<button type="button" onclick="editarMaterialAgregar();" class="btn btn-success">+ Agregar</button>							
							</div>
					</div>
				</div>
		  </div>
...
<div class="modal fade modalchs" data-backdrop="false" id="modalAccesoriosExternosAlta">
		<div class="modal-dialog">
			...
			<div class="modal-content">
			  <div class="modal-header azuldef">
					...
					<h4 class="modal-title"><i class="fa fa-check-circle-o" aria-hidden="true"></i> Agregar Material Externo(1496) </label> </h4>
				</div>
				...
				<div class="modal-body nopsides">
									...
									<table class="table table-striped" style="width: 100%;">
										<tbody>
											<tr>
												<td>Descripción Material:</td>
												<td style="width: 75%;">
													<input type="text" name="acc_descripcion_material_ext" id="acc_descripcion_material_ext" class="form-control input-sm"  maxlength="250">
												</td>
											</tr>
											<tr>
												<td>Clase:</td>
												<td>
												<select name="acc_clase_material_ext" id="acc_clase_material_ext" class="form-control">
													<option value="-1">Campo Obligatorio</option>
													<option value="EQPO">EQPO</option>
											...
											<tr>
												<td>Unidad:</td>
												<td>
													<select name="acc_unidad_material_ext" id="acc_unidad_material_ext" class="form-control">
													<option value="-1">Campo Obligatorio</option>
											...
											<tr>
												<td>No. de Parte:</td>
												<td>
													<input type="text" name="acc_no_parte_ext" id="acc_no_parte_ext" class="form-control" maxlength="45">
												</td>
											</tr>
											<tr>
												<td>Referencia:</td>
												<td>
													<input type="text" name="acc_referencia_ext" id="acc_referencia_ext" class="form-control" maxlength="45">
												</td>
											</tr>
											<tr>
												<td>Costo:</td>
												<td>
													<input type="text" name="acc_costo_material_ext" id="acc_costo_material_ext" class="form-control">
												</td>
											</tr>
											<tr>
												<td>Cantidad:</td>
												<td>
													<input type="text" name="acc_cantidad_material_ext" id="acc_cantidad_material_ext" class="form-control">
													<!-- <input type="number" name="acc_cantidad_material_ext" id="acc_cantidad_material_ext" min="0" step="1" value="0" onkeydown="return false;" class="form-control"> -->
												</td>
											</tr>
										</tbody>
									</table>
					...
					<div class="tab-content">
							<div class="modal-footer">
							<button type="button" onclick="editarMaterialExternoAgregar();" class="btn btn-success">+ Agregar</button>							
							</div>
					</div>
				</div>
		  </div>
...
<div class="modal fade modalchs" data-backdrop="false" id="modalAccesoriosExternosEditar">
		<div class="modal-dialog">
			...
			<div class="modal-content">
			  <div class="modal-header azuldef">
					...
					<h4 class="modal-title"><i class="fa fa-check-circle-o" aria-hidden="true"></i> Editar Material Externo <label id="id_materiales_edit"></label></h4>
				</div>
				...
				<div class="modal-body nopsides">
									...
									<table class="table table-striped" style="width: 100%;">
										<tbody>
											<tr>
												<td>Descripción Material</td>
												<td style="width: 75%;">
													<input type="text" name="acc_descripcion_material_ext_edit" id="acc_descripcion_material_ext_edit" class="form-control">
												</td>
											</tr>
											<tr>
												<td>Clase:</td>
												<td>
												<select name="acc_clase_material_ext_edit" id="acc_clase_material_ext_edit" class="form-control">
												<!-- <option value="-1" disabled>Campo Obligatorio</option>	
												<div id="acc_clase_material_ext_editar"></div> -->
												</select>
											</td>
											</tr>
											<tr>
												<td>Unidad:</td>
												<td>
													<select name="acc_unidad_material_ext_edit" id="acc_unidad_material_ext_edit" class="form-control">
													<!-- <option value="-1">Campo Obligatorio</option>
													<option id="acc_unidad_material_ext_editar"></option>													 -->
													</select>
												</td>
											</tr>
											<tr>
												<td>No. de Parte:</td>
												<td>
													<input type="text" name="acc_no_parte_ext_edit" id="acc_no_parte_ext_edit" class="form-control" maxlength="45">
												</td>
											</tr>
											<tr>
												<td>Referencia:</td>
												<td>
													<input type="text" name="acc_referencia_ext_edit" id="acc_referencia_ext_edit" class="form-control" maxlength="45">
												</td>
											</tr>
											<tr>
												<td>Costo:</td>
												<td>
													<input type="text" name="acc_costo_material_ext_edit" id="acc_costo_material_ext_edit" class="form-control">
												</td>
											</tr>
											<tr>
												<td>Cantidad:</td>
												<td>
													<input type="text" name="acc_cantidad_material_ext_edit" id="acc_cantidad_material_ext_edit" class="form-control">
													<!-- <input type="number" name="acc_cantidad_material_ext_edit" id="acc_cantidad_material_ext_edit" min="0" step="1" value="0" onkeydown="return false;" class="form-control"> -->
												</td>
											</tr>
										</tbody>
									</table>
					...
					<div class="tab-content">
							<div class="modal-footer">
							<button type="button" onclick="materialExternoActualizar();" class="btn btn-success">+ Guardar</button>							
							</div>
					</div>
				</div>
		  </div>
          ...
          <div class="modal-body nopsides">
                ...
                <div class="form-group" align="center">
							...
							<div class="col-md-12" align="left">
								<input type="button" class="btn btn-success" value="Guardar1820" style="display: inline-block;" onclick="guardar_activo_externo()">	
								<br><br>
							</div>
						</div>
...
$('#btnModalAlmacen').on('click', function(){
$('#acc_sku_material_a').html('');
$('#acc_clase_material_a').html('');
$('#acc_unidad_material_a').html('');
$('#acc_localizacion_a').html('');
$('#acc_existencia_a').html('');
$('#acc_costo_material_a').html('');
$('#acc_costo_material_a_costo').html('');
$('#acc_folio_almacen_material_a').val('');
$('#acc_cantidad_material_a').val('');
selectAccesorios();
$('#modalAccesoriosAlta').modal('show');
});

//==============================================================================================================================================================================================================
//==============================================================================================================================================================================================================

$('#combo_accesorios_assist').on('change', function(){
	let idAccesorioAssist = $('#combo_accesorios_assist').val();
	
		$.ajax({
			type: "POST",
			url: "/siga/class/biomedica/mtoPreventivo/mtoPreventivo.ajax.php",
			data: {accion: 19, idAccesorioAssist:idAccesorioAssist},
			dataType: "JSON",
			cache: false,
			async: false,
			beforeSend: function(){
			...
			success: function (response) {
				$('#acc_sku_material_a').html(response['art']);
				$('#acc_clase_material_a').html(response['s_lin']);
				$('#acc_unidad_material_a').html(response['uds_min']);
				$('#acc_localizacion_a').html(response['localizacion']);
				$('#acc_existencia_a').html(response['Existencia']);
				$('#acc_costo_material_a').html(response['cto_prom']);
				$('#acc_costo_material_a_costo').html(response['costo']);
				$('#loadingState').hide();	
			},
			error: function(){
				$('#loadingState').hide();
...
$('#btnModalExterno').on('click', function(){

		$('#acc_descripcion_material_ext').val('');
		$('#acc_cantidad_material_ext').val('');
		$('#acc_clase_material_ext').val(-1);
		$('#acc_unidad_material_ext').val(-1);
		$('#acc_costo_material_ext').val('');
		$('#acc_no_parte_ext').val('');
		$('#acc_referencia_ext').val('');

	$('#modalAccesoriosExternosAlta').modal('show');
});
...
//----------------------------------------------------------------------------
		...
		if(Estatus_Proceso=="1"){
			...
			if(Estatus_Proceso=="2"){
				...
				cargarMatAlmacen(id,2);
				cargarMatExterno(id,2);
				totalImporteMateriales(id);
				$('#btnModalAlmacen').show();
				$('#btnModalExterno').show();
				$('#lista_actividades_rutinas').show();
				$("#tablaActividadesSoloLectura").html('');
				$('#actividadesTicketrutinas').hide();
				...
				if(Estatus_Proceso=="3"){
					...
					$("#ticket_reclasificar_categoria").hide();
					$("#lista_actividades_rutinas").hide();

					cargarMatAlmacen(id,3);
					cargarMatExterno(id,3);
					totalImporteMateriales(id);
					cargarActividades(id);

					$('#btnModalAlmacen').hide();
					$('#btnModalExterno').hide();
					...
					if(Estatus_Proceso=="4"){
						...
						$("#tab_cerrar_ticket").click();
						$("#cambiar_area").hide();
						cargarMatAlmacen(id,4);
						cargarMatExterno(id,4);
						totalImporteMateriales(id);
						$("#lista_actividades_rutinas").hide();
						cargarActividades(id);
		...
		$('#act_id_operacion').val('');
		$('#act_fch_operacion').val('');
					   ...
					   $("#spanSubcategoria"+i).text(data.data[0].Subcategoria);
						 ...
						 if(Estatus_Proceso>1&& Estatus_Proceso<5){
							if((data.data[0].Id_Actividad!="")){
								$("#li_actividades").show();
								carga_actividades_rutinas(data.data[0].Id_Actividad, data.data[0].Fech_Solicitud,Estatus_Proceso);
...
//===================================================================================================================================================================================================
	...
	$("#botonCerrar").click(function(e){
		...
		let Id_Actividad 					= $('#act_id_operacion').val();
		let Fecha_Programada 			= $('#act_fch_operacion').val();		
		let contador 							= validarRutina(Id_Actividad,Fecha_Programada);
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		// if(contador !=0){
		// 			Agregar = false; 
		// 			mensaje_error_act += " -Falta "+contador+" actividades por llenar.<br>";
		// 		}
		...
		// if (!Agregar) {
			if(contador!=0){
				mensaje_error+="-Debe concluir las actividades de mantenimiento. (Faltan: "+contador+".).<br>";			
				$("#tab_ver_actividades").click();
			}
			
		// 	mensajesalerta("Informaci&oacute;n", mensaje_error+mensaje_error, "", "dark");
		// }
		if (!Agregar){
			mensajesalerta("Informaci&oacute;n", mensaje_error, "", "dark");
		}
...
//==========================================================================================================================================================================================================
	...
	carga_actividades_rutinas=function(id,Fech_Solicitud,Estatus_Proceso) {						
		//url_direccion_archivos="";
		$('#act_id_operacion').val(id);
		$('#act_fch_operacion').val(Fech_Solicitud);
		var Datos_Actividades='';
		
		if (id != "" && Fech_Solicitud != "") {
...
//==========================================================================================================================================================================================================
			...
			$.ajax({
				type: "POST",
				url: "/siga/class/biomedica/mtoPreventivo/mtoPreventivo.ajax.php",
				data: {accion : 1, id:id, Fech_Solicitud:Fech_Solicitud,Estatus_Proceso:Estatus_Proceso},
				dataType: "JSON",
				async: false,
				cache: false,
				beforeSend :function (){
...
//==========================================================================================================================================================================================================
			...
			$.ajax({
				...
				success: function (response) {
					$('#loadingState').hide();
					Datos_Actividades+='<span><strong>Nombre Rutina: </strong></span> <span style="color: #666;font-weight: normal;" >'+response+'</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
...
// 		let sku_vista_1 				= $("#sku_vista_1").html();
// 		let sku_vista_2 				= $("#sku_vista_2").html();
// 		let sku_vista_3 				= $("#sku_vista_3").html();
// 		let sku_vista_4 				= $("#sku_vista_4").html();
// 		let sku_vista_5 				= $("#sku_vista_5").html();
// 		let clase_1 						= $("#clase_1").html();
// 		let clase_2 						= $("#clase_2").html();
// 		let clase_3 						= $("#clase_3").html();
// 		let clase_4 						= $("#clase_4").html();
// 		let clase_5 						= $("#clase_5").html();
// 		let unidad_1 						= $("#unidad_1").html();
// 		let unidad_2 						= $("#unidad_2").html();
// 		let unidad_3 						= $("#unidad_3").html();
// 		let unidad_4 						= $("#unidad_4").html();
// 		let unidad_5 						= $("#unidad_5").html();
// 		let costo_1 						= $("#costo_1").html();
// 		let costo_2 						= $("#costo_2").html();
// 		let costo_3 						= $("#costo_3").html();
// 		let costo_4 						= $("#costo_4").html();
// 		let costo_5 						= $("#costo_5").html();
...
// 		let manual_descripcion_1 = $("#manual_descripcion_1").val();
// 		let manual_descripcion_2 = $("#manual_descripcion_2").val();
// 		let manual_descripcion_3 = $("#manual_descripcion_3").val();
// 		let manual_descripcion_4 = $("#manual_descripcion_4").val();
// 		let manual_descripcion_5 = $("#manual_descripcion_5").val();
...
// 			if(manual_codigo_de_barras_1 == '' || manual_costo_1=='' || manual_cantidad_1 ==''){
// 				alert('faltan datos línea 1');
// 				validar = false;
// 			}
// 			arrayAccesorios.push({'descripcion':manual_descripcion_1,'Folio_Almacen':'','sku':manual_codigo_de_barras_1,'clase':'','unidad':'','costo':manual_costo_1,'cantidad':manual_cantidad_1});	
// 		}

// 		if(manual_descripcion_2 !=''){
// 			if(manual_codigo_de_barras_2 == '' || manual_costo_2=='' || manual_cantidad_2 ==''){
// 				alert('faltan datos línea 2');
// 				validar = false;
// 			}
// 			arrayAccesorios.push({'descripcion':manual_descripcion_2,'Folio_Almacen':'','sku':manual_codigo_de_barras_2,'clase':'','unidad':'','costo':manual_costo_2,'cantidad':manual_cantidad_2});
// 		}

// 		if(manual_descripcion_3 !=''){
// 			if(manual_codigo_de_barras_3 == '' || manual_costo_3=='' || manual_cantidad_3 ==''){
// 				alert('faltan datos línea 3');
// 				validar = false;
// 			}
// 			arrayAccesorios.push({'descripcion':manual_descripcion_3,'Folio_Almacen':'','sku':manual_codigo_de_barras_3,'clase':'','unidad':'','costo':manual_costo_3,'cantidad':manual_cantidad_3});
// 		}

// 		if(manual_descripcion_4 !=''){
// 			if(manual_codigo_de_barras_4 == '' || manual_costo_4=='' || manual_cantidad_4 ==''){
// 				alert('faltan datos línea 4');
// 				validar = false;
// 			}
// 			arrayAccesorios.push({'descripcion':manual_descripcion_4,'Folio_Almacen':'','sku':manual_codigo_de_barras_4,'clase':'','unidad':'','costo':manual_costo_4,'cantidad':manual_cantidad_4});
// 		}

// 		if(manual_descripcion_5 !=''){
// 			if(manual_codigo_de_barras_5 == '' || manual_costo_5=='' || manual_cantidad_5 ==''){
// 				alert('faltan datos línea 5');
// 				validar = false;
// 			}
// 			arrayAccesorios.push({'descripcion':manual_descripcion_5,'Folio_Almacen':'','sku':manual_codigo_de_barras_5,'clase':'','unidad':'','costo':manual_costo_5,'cantidad':manual_cantidad_5});
// 		}

// 		if(combo_accesorios_1 != ''){
// 			if(Folio_Almacen_1==''){
// 				alert('Folio almacen obligatorio');
// 				validar=false;
// 			} else if(!$.isNumeric(cantidad_1)){
// 				alert('Cantidad obligatorio');
// 				validar=false;
// 			}
// 			arrayAccesorios.push({'descripcion':combo_accesorios_1,'Folio_Almacen':Folio_Almacen_1,'sku':sku_vista_1,'clase':clase_1,'unidad':unidad_1,'costo':costo_1,'cantidad':cantidad_1});			
// 		}
...
// 				alert('Folio almacen obligatorio');
// 				validar=false;
// 			} else if(!$.isNumeric(cantidad_2)){
// 				alert('Cantidad obligatorio');
// 				validar=false;
// 			}
// 			arrayAccesorios.push({'descripcion':combo_accesorios_2,'Folio_Almacen':Folio_Almacen_2,'sku':sku_vista_2,'clase':clase_2,'unidad':unidad_2,'costo':costo_2,'cantidad':cantidad_2});
// 		}
...
// 				alert('Folio almacen obligatorio');
// 				validar=false;
// 			} else if(!$.isNumeric(cantidad_3)){
// 				alert('Cantidad obligatorio');
// 				validar=false;
// 			}			
// 			arrayAccesorios.push({'descripcion':combo_accesorios_3,'Folio_Almacen':Folio_Almacen_3,'sku':sku_vista_3,'clase':clase_3,'unidad':unidad_3,'costo':costo_3,'cantidad':cantidad_3});
// 		}
...
// 				alert('Folio almacen obligatorio');
// 				validar=false;
// 			} else if(!$.isNumeric(cantidad_4)){
// 				alert('Cantidad obligatorio');
// 				validar=false;
// 			}			
// 			arrayAccesorios.push({'descripcion':combo_accesorios_4,'Folio_Almacen':Folio_Almacen_4,'sku':sku_vista_4,'clase':clase_4,'unidad':unidad_4,'costo':costo_4,'cantidad':cantidad_4});
// 		}
...
// 				alert('Folio almacen obligatorio');
// 				validar=false;
// 			} else if(!$.isNumeric(cantidad_5)){
// 				alert('Cantidad obligatorio');
// 				validar=false;
// 			}
// 			arrayAccesorios.push({'descripcion':combo_accesorios_5,'Folio_Almacen':Folio_Almacen_5,'sku':sku_vista_5,'clase':clase_5,'unidad':unidad_5,'costo':costo_5,'cantidad':cantidad_5});
// 		}	

// 		if(validar == false){
// 			$("#tab_ver_materiales").click();
// 		}
...
// 			// 	type: "POST",
// 			// 	url: "/siga/class/biomedica/mtoPreventivo/mtoPreventivo.ajax.php",
// 			// 	data: {accion:10, Id_Usuario:Id_Usuario, Id_Solicitud:Id_Solicitud, arrayAccesorios:arrayAccesorios},
// 			// 	dataType: "JSON",
// 			// 	cache: false,
// 			// 	beforeSend: function(){
...
//============================================================================================================================================================================================================
	...
	function sigaValidarActividades(id, valida1, valida2, descripcion,miAccion){
...
//============================================================================================================================================================================================================
		...
		if(validar){
			$.ajax({
				...
				error:function(response){
					$('#loadingState').hide();					
					mensajesalerta("SIGA: ", "Ocurrio un error al validar rutina(10383).", "error", "dark");
				}
...
//============================================================================================================================================================================================================
	...
	function sigaActividadesEliminarImagen(idActividad,Fech_Solicitud2,id){
		...
		if(confirm('¿Desea eliminar el archivo?')){
				...
				error: function(){
					$('#loadingState').hide();					
					mensajesalerta("SIGA: ", "Ocurrio un error al eliminar la Imagen(10415).", "error", "dark");
				}
			});
			s
	}
...
//============================================================================================================================================================================================================
	...
	function validarRutina(Id_Actividad,Fecha_Programada){		
		let contador ='';

		$.ajax({
			type: "POST",
			url: "/siga/class/biomedica/mtoPreventivo/mtoPreventivo.ajax.php",
			data: {accion:8, Id_Actividad:Id_Actividad, Fecha_Programada:Fecha_Programada},
			dataType: "JSON",
			async: false,
			cache: false,
				beforeSend: function(){  },
				...
				error: function(){
					mensajesalerta("SIGA: ", "Ocurrio un error al Validar la rutina.", "error", "dark");
				}			
		});
	...
	function selectAccesorios(){
		...
		$.ajax({			
			...
			data: {accion:18},
				...
				success:function(response) {		
						$("#combo_accesorios_assist").html(response);
						$("#combo_accesorios_assist").selectize();
						let control = $("#combo_accesorios_assist")[0].selectize;
							control.clear();
								$('#loadingState').hide();
				},
				error: function(response){
...
function cargarMatAlmacen(Id_Solicitud,Estatus_Proceso){

$.ajax({
	type: "POST",
	url: "/siga/class/biomedica/mtoPreventivo/mtoPreventivo.ajax.php",
	data: {accion:14,Id_Solicitud:Id_Solicitud, origen_alm_ext:1,Estatus_Proceso:Estatus_Proceso},
	dataType: "JSON",
	cache: false,
	async: false,
	beforeSend: function(response){
...
function cargarMatExterno(Id_Solicitud,Estatus_Proceso){
	$.ajax({
	type: "POST",
	url: "/siga/class/biomedica/mtoPreventivo/mtoPreventivo.ajax.php",
	data: {accion:14,Id_Solicitud:Id_Solicitud, origen_alm_ext:2,Estatus_Proceso:Estatus_Proceso},
	dataType: "JSON",
	cache: false,
	async: false,
	beforeSend: function(response){
...
function totalImporteMateriales(Id_Solicitud){
	$.ajax({
	type: "POST",
	url: "/siga/class/biomedica/mtoPreventivo/mtoPreventivo.ajax.php",
	data: {accion:21,Id_Solicitud:Id_Solicitud},
	dataType: "JSON",
	cache: false,
	async: false,
	beforeSend: function(response){
	...
	success: function (response) {
		$("#totalImporteMateriales").text(response);		
	},
	error: function(response){
		console.log(response);
	}
...
function eliminarMaterial(id_material){	
	let Id_Solicitud 	= $("#spanNumsolicitud1").text();
	let Id_Usuario 		= $("#usuariosesion").val();
	
	$.confirm({
    title: 'SIGA',
    content: '¿Quiere eliminar el material?',
		icon: 'fa fa-question',
		type: 'red',
    buttons: {
        Confirmar: function () {
					...
					$.ajax({
						type: "POST",
						url: "/siga/class/biomedica/mtoPreventivo/mtoPreventivo.ajax.php",
						data: {accion:15, id_material:id_material,Id_Usuario:Id_Usuario},
						dataType: "JSON",
						cache: false,
						async: false,
						beforeSend: function(){
						...
						success: function (response) {							
							cargarMatAlmacen(Id_Solicitud,2);
							cargarMatExterno(Id_Solicitud,2);
							totalImporteMateriales(Id_Solicitud);
						},
						error: function (response){
							mensajesalerta("SIGA: ", "Ocurrio un error al eliminar el material.", "error", "dark");
						}
					});
...
function editarMaterial(id_material){
	...
	$.ajax({
		type: "POST",
		url: "/siga/class/biomedica/mtoPreventivo/mtoPreventivo.ajax.php",
		data: {accion:16, id_material:id_material},
		dataType: "JSON",
		cache: false,
		async: false,
		beforeSend: function(){
		...
		success: function (response) {
			$('#id_materiales').text(response['id_materiales']);
			$('#acc_descripcion_material').text(response['descripcion_material']);
			$('#acc_sku_material').text(response['sku_material']);
			$('#acc_clase_material').text(response['clase_material']);
			$('#acc_unidad_material').text(response['unidad_material']);
			$('#acc_costo_material').text(response['costo_material']);
			$('#acc_folio_almacen_material').val(response['folio_almacen_material']);
			$('#acc_cantidad_material').val(response['cantidad_material']);
...
function editarMaterialExterno(id_material){

	$('#acc_descripcion_material_ext_edit').val('');
		$('#acc_no_parte_ext_edit').val('');
		$('#acc_referencia_ext_edit').val('');
		$('#acc_costo_material_ext_edit').val('');
		$('#acc_cantidad_material_ext_edit').val('');	

	getClase(id_material);
	getUnidad(id_material);
	$('#id_materiales_edit').text(id_material);
		...
		$.ajax({
			...
			success: function (response) {
				...
				$('#acc_descripcion_material_ext_edit').val(response['descripcion_material']);
				$('#acc_no_parte_ext_edit').val(response['numDeParte']);
				$('#acc_referencia_ext_edit').val(response['referencia']);
				$('#acc_costo_material_ext_edit').val(response['costo_material']);
				$('#acc_cantidad_material_ext_edit').val(response['cantidad_material']);		
				
				$('#modalAccesoriosExternosEditar').modal('show');
			},
			error: function(response){
...
function editarMaterialUpdate(){
	let id_materiales 							= $('#id_materiales').text();
	let acc_folio_almacen_material 	= $('#acc_folio_almacen_material').val();
	let acc_cantidad_material 			= $('#acc_cantidad_material').val();
	let Id_Usuario 									= $("#usuariosesion").val();
	let Id_Solicitud 								= $("#spanNumsolicitud1").text();
	let validar 										= true;
	...
	} else if(acc_folio_almacen_material==''){
		alerta('red', '<b>Folio de almacen: </b> es campo Obligatorio.');
	validar = false;
	}  else if (Number.isInteger(Number(acc_cantidad_material)) == false){
		$('#acc_cantidad_material').val('');
			alerta('red', '<b>Cantidad</b> Verificar información.');
		validar = false;		
	}
	...
	if(validar){
		...
		$.ajax({
			type: "POST",
			url: "/siga/class/biomedica/mtoPreventivo/mtoPreventivo.ajax.php",
			data: {accion:17, id_materiales:id_materiales, acc_folio_almacen_material:acc_folio_almacen_material, acc_cantidad_material:acc_cantidad_material, Id_Usuario:Id_Usuario},
			dataType: "JSON",
			cache: false,
			async: false,
			beforeSend: function(){
				$('#acc_actualizarAccesorio').prop('disabled', true);
			},
			success: function (response) {
				cargarMatAlmacen(Id_Solicitud,2);
				cargarMatExterno(Id_Solicitud,2);
				totalImporteMateriales(Id_Solicitud);
				$('#acc_actualizarAccesorio').prop('disabled', false);
...
function editarMaterialAgregar(){

	let Id_Usuario 							= $("#usuariosesion").val();
	let Id_Solicitud 						= $("#spanNumsolicitud1").text();	
	let combo_accesorios_assist = $('#combo_accesorios_assist').text();	
	let acc_folio_almacen_material_a = $('#acc_folio_almacen_material_a').val();
	let acc_cantidad_material_a = $('#acc_cantidad_material_a').val();
	let acc_sku_material_a 			= $('#acc_sku_material_a').html();
	let acc_clase_material_a 		= $('#acc_clase_material_a').html();
	let acc_unidad_material_a 	= $('#acc_unidad_material_a').html();
	let acc_costo_material_a 		= $('#acc_costo_material_a_costo').html();	
	let validar 								= true;

	if(acc_folio_almacen_material_a == ''){
		alerta('red', '<b>Folio de almacen</b> es campo Obligatorio.');
		$('#acc_folio_almacen_material_a').val('');
		validar = false;
	} else if (Number.isInteger(Number(acc_cantidad_material_a)) == false){
		$('#acc_cantidad_material_a').val('');
			alerta('red', '<b>Cantidad</b> Verificar información.');
		validar = false;		
	}
	...
	if(validar){ 
		$.ajax({
			type: "POST",
			url: "/siga/class/biomedica/mtoPreventivo/mtoPreventivo.ajax.php",
			data: {accion: 20, Id_Solicitud:Id_Solicitud, combo_accesorios_assist:combo_accesorios_assist, acc_folio_almacen_material_a:acc_folio_almacen_material_a, 
							acc_sku_material_a:acc_sku_material_a, acc_clase_material_a:acc_clase_material_a, acc_unidad_material_a:acc_unidad_material_a, acc_costo_material_a:acc_costo_material_a, 
							acc_cantidad_material_a:acc_cantidad_material_a, Id_Usuario:Id_Usuario,origen_alm_ext:1},
			dataType: "JSON",
			cache: false,
			async: false,
			beforeSend: function(){
			...
			success: function (response) {				
				...
				totalImporteMateriales(Id_Solicitud);
					$.alert({
						title: 'SIGA',
						type: 'green',
						content: 'Se agrego material de manera éxitosa.',
						});
				$('#loadingState').hide();
				$('#modalAccesoriosAlta').modal('hide');
			},
			error: function (){
				$('#loadingState').hide();
			}
...
function editarMaterialExternoAgregar(){

let Id_Usuario 							= $("#usuariosesion").val();
let Id_Solicitud 						= $("#spanNumsolicitud1").text();	
let combo_accesorios_assist = $('#acc_descripcion_material_ext').val();
let acc_cantidad_material_a = $('#acc_cantidad_material_ext').val();
let acc_clase_material_a 		= $('#acc_clase_material_ext').val();
let acc_unidad_material_a 	= $('#acc_unidad_material_ext').val();
let acc_costo_material_a 		= $('#acc_costo_material_ext').val();
let acc_no_parte_ext 				= $('#acc_no_parte_ext').val();
let acc_referencia_ext 			= $('#acc_referencia_ext').val();
let acc_folio_almacen_material_a = '';
let acc_sku_material_a 			= '';
let validar 								= true;

if(combo_accesorios_assist == ''){
	alerta('red', '<b>Descripción de material</b> es campo Obligatorio.');
	validar = false;
} else if (acc_clase_material_a == -1){
	alerta('red', '<b>Clase</b> es campo obligatorio.');
	validar=false;
} else if (acc_unidad_material_a == -1){
	alerta('red', '<b>Unidad</b> es campo obligatorio.');
	validar=false;
} else if (acc_no_parte_ext == ''){
	alerta('red', '<b>No. de Parte</b> campo obligatorio.');
	validar = false;
} else if (acc_referencia_ext == ''){
	alerta('red', '<b>Referencia</b> campo obligatorio.');
	validar = false;
} else if ($.isNumeric(acc_costo_material_a) == false){
	alerta('red', '<b>Costo</b> campo obligatorio.');
	validar = false;
} else if (Number.isInteger(Number(acc_cantidad_material_a)) == false){
	alerta('red', '<b>Cantidad:</b> Verificar información.');
	$('#acc_cantidad_material_a').val('');
	...
	if(validar){
		$.ajax({
			...
			data: {accion: 20, Id_Solicitud:Id_Solicitud, combo_accesorios_assist:combo_accesorios_assist, acc_folio_almacen_material_a:acc_folio_almacen_material_a, 
							acc_sku_material_a:acc_sku_material_a, acc_clase_material_a:acc_clase_material_a, acc_unidad_material_a:acc_unidad_material_a, acc_costo_material_a:acc_costo_material_a, 
							acc_cantidad_material_a:acc_cantidad_material_a, Id_Usuario:Id_Usuario,origen_alm_ext:2, acc_no_parte_ext:acc_no_parte_ext, acc_referencia_ext:acc_referencia_ext},
			dataType: "JSON",
			cache: false,
			async: false,
			beforeSend: function(){
			...
			success: function (response) {
					...
					cargarMatExterno(Id_Solicitud,2);
					totalImporteMateriales(Id_Solicitud);
					alerta('green', 'Se agrego material de manera éxitosa.');
				$('#loadingState').hide();
				$('#modalAccesoriosExternosAlta').modal('hide');
			},
			error: function (){
				$('#loadingState').hide();
			}
...
function getClase(id_materiales){

	$.ajax({
			type: "POST",
			url: "/siga/class/biomedica/mtoPreventivo/mtoPreventivo.ajax.php",
			data: {accion: 22, id_materiales:id_materiales},
			dataType: "JSON",
			cache: false,
			async: false,
			beforeSend: function(){
			...
			success: function (response) {
				$('#acc_clase_material_ext_edit').html(response);				
				$('#loadingState').hide();
			},
			error: function (){
				$('#loadingState').hide();
...
function getUnidad(id_materiales){

	$.ajax({
			type: "POST",
			url: "/siga/class/biomedica/mtoPreventivo/mtoPreventivo.ajax.php",
			data: {accion: 23, id_materiales:id_materiales},
			dataType: "JSON",
			cache: false,
			async: false,
			beforeSend: function(){
			...
			success: function (response) {
				$('#acc_unidad_material_ext_edit').html(response);				
				$('#loadingState').hide();
			},
			error: function (){
				$('#loadingState').hide();
...
function materialExternoActualizar(){
	let Id_Usuario 							= $("#usuariosesion").val();
	let Id_Solicitud 						= $("#spanNumsolicitud1").text();	
	let validar 								= true;	

	let acc_descripcion_material_ext_edit = $('#acc_descripcion_material_ext_edit').val();
	let acc_clase_material_ext_edit				= $('#acc_clase_material_ext_edit').val();
	let acc_unidad_material_ext_edit			= $('#acc_unidad_material_ext_edit').val();	
	let acc_no_parte_ext_edit							= $('#acc_no_parte_ext_edit').val();
	let acc_referencia_ext_edit						= $('#acc_referencia_ext_edit').val();
	let acc_costo_material_ext_edit  			= $('#acc_costo_material_ext_edit').val();
	let acc_cantidad_material_ext_edit		= $('#acc_cantidad_material_ext_edit').val();
	let id_materiales_edit								= $('#id_materiales_edit').text();

	if(acc_descripcion_material_ext_edit ==''){
		alerta('red', '<b>Descripción de material</b> campo obligatorio.');
		validar = false;
	} else if (acc_clase_material_ext_edit == -1){
		alerta('red', '<b>Clase</b> campo obligatorio.');
		validar = false;
	} else if (acc_unidad_material_ext_edit == -1){
		alerta('red', '<b>Unidad</b> campo obligatorio.');
		validar = false;
	} else if (acc_no_parte_ext_edit == ''){
		alerta('red', '<b>Número de parte</b> campo obligatorio.');
		validar = false;
	} else if (acc_referencia_ext_edit == ''){
		alerta('red', '<b>Referencia</b> campo obligatorio.');
		validar = false;
	} else if ($.isNumeric(acc_costo_material_ext_edit) == false){
		alerta('red', '<b>Costo</b> campo obligatorio.');
		validar = false;
	} else if (Number.isInteger(Number(acc_cantidad_material_ext_edit)) == false){
		alerta('red', '<b>Cantidad </b> Verificar información.');
		$('#acc_cantidad_material_ext_edit').val('');
		validar = false;
	}
	...
	if(validar){
		...
		$.ajax({
				type: "POST",
				url: "/siga/class/biomedica/mtoPreventivo/mtoPreventivo.ajax.php",
				data: {accion: 24, id_materiales_edit:id_materiales_edit,acc_descripcion_material_ext_edit:acc_descripcion_material_ext_edit,acc_clase_material_ext_edit:acc_clase_material_ext_edit,
					acc_unidad_material_ext_edit:acc_unidad_material_ext_edit, acc_no_parte_ext_edit:acc_no_parte_ext_edit, acc_referencia_ext_edit:acc_referencia_ext_edit, acc_costo_material_ext_edit:acc_costo_material_ext_edit,
					acc_cantidad_material_ext_edit:acc_cantidad_material_ext_edit, Id_Usuario:Id_Usuario},
				dataType: "JSON",
				cache: false,
				async: false,
				beforeSend: function(){
				...
				success: function (response) {
					...
					cargarMatExterno(Id_Solicitud,2);
					totalImporteMateriales(Id_Solicitud);
					alerta('green', 'Se actualizo material de manera éxitosa.');
					$('#loadingState').hide();
					$('#modalAccesoriosExternosEditar').modal('hide');
				},
				error: function (){
					$('#loadingState').hide();
				}
