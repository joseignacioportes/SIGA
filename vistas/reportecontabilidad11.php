                    ...
                    <tbody>
					 ...
					 { 
                      ...
                      <tr>
						...
						<td style="<?php echo $style_size_table;?>"><?php echo $aniosArr[0]["MesesVida"]+$aniosArr[0]["MesesRestantes"] ?></td>
						<td style="<?php echo $style_size_table;?>"><?php echo $aniosArr[0]["PorcentajeAnual"] ?></td>
						<td style="<?php echo $style_size_table;?>"><?php echo $aniosArr[0]["mesesuso"] ?></td>
						<td style="<?php echo $style_size_table;?>"><?php echo ($aniosArr[0]["MesesDepreciarAcumulada"]-$aniosArr[0]["mesesuso"] )?></td>
						<td style="<?php echo $style_size_table;?>"><?php echo 1 ?></td>
						<td style="<?php echo $style_size_table;?>"><?php echo $aniosArr[0]["mesesuso"]+1 ?></td>
						<?php
						$mespendep = 0;
						if ($aniosArr[0]["mesespendientesdepreciarmesfin"] >0)  
						$mespendep =$aniosArr[0]["mesespendientesdepreciarmesfin"]-1;
						?>
						<td style="<?php echo $style_size_table;?>"><?php echo $mespendep ?></td>
						<td style="<?php echo $style_size_table;?>">$<?php echo number_format($aniosArr[0]["depreciacionacumuladamensual"],2) ?></td>
						...
						<td style="<?php echo $style_size_table;?>">$<?php echo number_format($aniosArr[0]["depreciacionacumuladamesfin"],2) ?></td>
						<?php
						$moipendep = 0;
						if ($aniosArr[0]["MOI"]-$aniosArr[0]["depreciacionacumuladamesfin"] >=0)  
						$moipendep =$aniosArr[0]["MOI"]-$aniosArr[0]["depreciacionacumuladamesfin"];						
						?>
...
<script>
 ...
 $("#btnBuscar").click(function(e){
	 e.preventDefault();
	 if ($("#cmbAnual").val() == 0)
	 loadOptionBandejas('reportecontabilidad11.php?Id_Menu=5&Id_Submenu=7&Anio='+$("#cmbAnioFiltro").val()+'&Anual='+$("#cmbAnual").val(),'contenedorprincipalactivofijo','818'); 
	 else
	 loadOptionBandejas('reportecontabilidad1.php?Id_Menu=5&Id_Submenu=7&Anio='+$("#cmbAnioFiltro").val()+'&Anual='+$("#cmbAnual").val()+'&Mes='+$("#cmbMesFiltro").val(),'contenedorprincipalactivofijo','818'); 
 });
 ...
 function abreDetalle(AF_BC,Anio,Formula,Mes)
 {
	...
	$.ajax({
		url : 'includedepcontablelinearecta.php',
			type : "post",
			dataType: 'html',
			data : { AF_BC: AF_BC,Anio:Anio,Formula:Formula,Mes: Mes, Reporte:1},
