...
<script>
 ...
 $("#btnBuscar").click(function(e){
	 e.preventDefault();
	 loadOptionBandejas('reportepoliza2.php?Id_Menu=5&Id_Submenu=1035&Anio='+$("#cmbAnio").val()+'&Mes='+$("#cmbMes").val()+'&Agrupar='+$('#cmbAgrupar').val(),'contenedorprincipalactivofijo','818'); 
 });
