...
<script>
 ...
 $("#btnBuscar").click(function(e){
	 //e.preventDefault();
	 if ($("#cmbAnual").val() == 0)
	 loadOptionBandejas('reportecontabilidad2.php?Id_Menu=5&Id_Submenu=7&Anio='+$("#cmbAnioFiltro").val()+'&Anual='+$("#cmbAnual").val()+'&INPCPeriodo='+$("#cmbINPC").val(),'contenedorprincipalactivofijo','3016'); 
	 else
	 loadOptionBandejas('reportecontabilidad2.php?Id_Menu=5&Id_Submenu=7&Anio='+$("#cmbAnioFiltro").val()+'&Anual='+$("#cmbAnual").val()+'&Mes='+$("#cmbMesFiltro").val()+'&INPCPeriodo='+$("#cmbINPC").val(),'contenedorprincipalactivofijo','3016'); 
 ...
 function abreDetalle(AF_BC,Anio,Formula,Mes,Id_Activo,INPC)
 {
	...
	$.ajax({
		url : 'includedepcontablelinearecta.php',
			type : "post",
			dataType: 'html',
			data : { AF_BC: AF_BC,Anio:Anio,Formula:Formula,Mes: Mes, Reporte:1,Id_Activo:Id_Activo,Fiscal:1,INPC:INPC},
