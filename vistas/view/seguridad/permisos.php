...
$menuInfo     = $catalogosClass->getSigaMenu();
?>
<div class="row">
	<div class="container">
<!------------------------------------------------------------------------------------------------------------------------------------------------------>
...
<!------------------------------------------------------------------------------------------------------------------------------------------------------>
			...
			<div class="panel">
				<div class="panel-heading bg-info">SIGA - Permisos</div>
<!------------------------------------------------------------------------------------------------------------------------------------------------------>
					<br>
						<button type="button" class="btn btn-primary btn-sm" id='siga_usuarios_agregar'> + Agregar Permiso</button>
           		<br><br>
							<table class="table table-striped" id='datatable_siga_permisos'>
								<thead class="thead-light">
									<tr>
										<th>Permiso</th><th>Acción</th>
									</tr>
								</thead>
								<tbody>
