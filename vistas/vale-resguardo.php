          ...
          <div class="info-box verde">          
            <a href="#" data-toggle="modal" data-target="#verificacionActivo" onclick="limpiarcampos()">
              ...
              <div class="info-box-content">
				...
				<div class="col-md-3 col-sm-6 col-xs-12" id="valeResguardoMasivo">
					<div class="info-box">
						<span class="info-box-icon" style="background-color:#19294a; color:white;"><i class="fa fa-envelope-o" aria-hidden="true"></i></span>
							<div class="info-box-content">
								<h3 class="info-box-text">Vale Masivo</h3>
							</div>
					</div>
				</div>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header verde">
            ...
            <h4 class="modal-title"> Imprimir vale de resguardo(101)</h4>
          </div>
          <div class="modal-body nopsides">
            ...
            <div class="tab-content">
              ...
              <div class="form-group">
                <textarea type="text" class="form-control" maxlength="400" placeholder="Observaciones" id="text_Observaciones" rows="6"></textarea>
              </div>
            </div>
						...
						<div class="col-md-12 col-sm-12 col-xs-12 form-group" id="div_enviar_correo">
							...
							<div class="form-group">
                <textarea type="text" class="form-control" placeholder="Mensaje del Correo" id="text_mensaje_correo" rows="5">Esta responsiva de equipo sustituye a las de fecha de emisión anterior a esta, firmar el vale y enviar a Cesar Leon, Gabriel Chan. Verificar que todos sus archivos importantes se guarden dentro de la carpeta de TRABAJO. TODOS LOS EQUIPOS MENCIONADOS INCLUYEN CABLES DE CARGA, SEÑAL Y ADAPTADORES (SEGUN SEA EL CASO), PARA SU CORRECTO FUNCIONAMIENTO.</textarea>
              </div>
            </div>
					  <br><br>
      ...
      <div class="modal-dialog modal-lg" style="overflow-y: scroll; max-height:100%;  margin-top: 50px; margin-bottom:50px;">
        <div class="modal-content">
          <div class="modal-header azuldef">
            ...
            <h4 class="modal-title">Activos(234)</h4>
          </div>
...
<!-- ==================================================================================================================================================================================================== -->
	    <!-- modal Activos -->
<div class="modal fade modalchs" id="modalSubirEDC" name="modalSubirEDC" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" style="max-height:100%;  margin-top: 50px; margin-bottom:50px;">
		<div class="modal-content">
			<div class="modal-header azuldef">
				...
				<h4 class="modal-title">Subir Vale a EDC</h4>
			</div>

					<div class="modal-body nopsides npt">
			<form enctype='multipart/form-data' id="formularioVRD" name="formularioVRD">
						<div class="tab-content">
							<div role="tabpanel" class="tab-pane active" id="generales">								
							
									<div class="box box-primary">
										<div class="box-header with-border">
											<h3 class="box-title"><p class="help-block"><span id="vrdId_Vale_Resguardo" style="display: none;"></span><span id="vrdNumEmpleado"></span>&nbsp;-&nbsp;<span id="vrdNombreEmpleado"></span></p></h3>
										</div>
										<div class="box-body">

											<div class="form-group">
												<label for="exampleInputFile"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> PDF Firmado Digitalmente</label>
													<input type="file" id="pdfEdc" accept="application/pdf">
											</div>

											<div class="checkbox">
												<label>
													<input type="checkbox" id="vrdNumEmpleadoBaja"> Vale de Baja
												</label>
											</div>
					...
					<div class="modal-footer">
						<button type="button" class="btn chs" id="subirEdcPdf">Subir</button>
						<button type="button" class="btn chs"  data-dismiss="modal">Cerrar</button>
					</div>
			</form>
...
<!-- ==================================================================================================================================================================================================== -->
	    <!-- modal Activos -->
<div class="modal fade modalchs" id="modalValeMasivo" name="modalValeMasivo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" style="max-height:100%;  margin-top: 50px; margin-bottom:50px;">
		<div class="modal-content">
			<div class="modal-header azuldef">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
				...
				<h4 class="modal-title">Vale de Resguardo Masivo</h4>
			</div>
					<div class="modal-body nopsides npt">
							...
							<div role="tabpanel" class="tab-pane active" id="generales">
								...
								<div class="box-body" >
									...
									<div class="form-group">
										<div class="radio">
											<label>
												<input type="radio" name="valeMasivoTipo" id="valeMasivoTipo" value="1" checked>
												Especifico
											</label>
										</div>
										<div class="radio">
											<label>
												<input type="radio" name="valeMasivoTipo" id="valeMasivoTipo" value="2">
												Global
											</label>
										</div>
									</div>
				...
				<div class="modal-footer">
				<button type="button" class="btn chs" id="valeMasivoGenerar">Generar Vale de Resguardo Masivo</button>
				<button type="button" class="btn chs"  data-dismiss="modal">Cerrar</button>
				</div>
		</div>
	<!-- /.modal-content -->
...
//==========================================================================================================================================================================================================================================
	...
	limpiarcampos=function(){
		...
		$("#txt_telefono").val("");
		$("#txt_correo").val("");
		$("#text_Observaciones").val("Esta responsiva de equipo ::: sustituye a las de fecha de emisión anterior a esta, firmar el vale y enviar a Cesar León, Gabriel Chan. Verificar que todos sus archivos importantes se guarden dentro de la carpeta de TRABAJO. TODOS LOS EQUIPOS MENCIONADOS INCLUYEN CABLES DE CARGA, SEÑAL Y ADAPTADORES (SEGÚN SEA EL CASO), PARA SU CORRECTO FUNCIONAMIENTO.");
	...
	function tabla_vale_Resguardo()
	{
		$.ajax({
			...
			success: function (datos) {
				...
				contenido+='	   <th>PDF</th>';
				contenido+='	   <th>EDC</th>';
				contenido+='	   <th>EDC/PDF</th>';
				contenido+='	   <th>Estatus</th>';				
				contenido+='	   <th>Enviado por:</th>';
				...
				if(json.totalCount>0)
				{
					for (var i = 0; i < json.totalCount; i++) {
						...
						contenido+='			<td><i class="fa fa-upload" aria-hidden="true" title="EDC Subir" onclick="subirValeEdc('+json.data[i].Id_Vale_Resguardo+','+json.data[i].Num_Empleado+',\''+json.data[i].nombre_completo+'\')"></i></td>';						

						if(json.data[i].envioEdc=='1'){
							contenido+='			<td><i class="fa fa-file-pdf-o" aria-hidden="true" title="EDC Vale" onclick="abrirValeEdc('+json.data[i].Num_Empleado+')"></i></td>';
						}else{
							contenido+='			<td></td>';
						}
						...
						contenido+='			<td>'+json.data[i].Usr_Inser+'</td>';
...
//==============================================================================================================================================================================================================
	...
	$('#valeResguardoMasivo').on('click', function(){	
		$('#modalValeMasivo').modal('show');
	});

//==============================================================================================================================================================================================================
//==============================================================================================================================================================================================================

	$('#valeMasivoGenerar').on('click', function(){
		
		let idareasesion 		= $("#idareasesion").val();
		let Usr_Inser				= $("#usuariosesion").val();
		let valeMasivoTipo	= $("input[name='valeMasivoTipo']:checked").val();

		$.confirm({
				title: 'SIGA.',
				content: '¿Desea generar el vale de resguardo masivo?',
				...
				buttons: {
						Confirmar: function () {
							...
							$.ajax({
								url: "/siga/class/admin/valeDeResguardo/valeDeResguardo.ajax.php",
								type: 'POST',
								dataType: 'JSON',
								data: {accion:1, idareasesion:idareasesion, Usr_Inser:Usr_Inser, valeMasivoTipo:valeMasivoTipo},
								cache:false,
								async: false,
								beforeSend: function(){
								...
								success: function(response){
									...
									alerta('success','Se genero de manera adecuada vale masivo.');
									$('#modalValeMasivo').modal('hide');
								},
								error: function(){
									alerta('error','No se genero de manera adecuadael vale masivo');
								}
							});        	
...
//==============================================================================================================================================================================================================
	...
	$('#subirEdcPdf').on('click', function(){
		let validar 						= true;
		let Usr_Inser						= $("#usuariosesion").val();
		let vrdNumEmpleado 			= $('#vrdNumEmpleado').html();
		let vrdId_Vale_Resguardo= $('#vrdId_Vale_Resguardo').html();
		let valePDF 						= $('#pdfEdc')[0].files[0];
		let vrdNumEmpleadoBaja 	= $("#vrdNumEmpleadoBaja").is(':checked');
		let valePDFForm 				= new FormData();
		
		if(valePDF == undefined){
			mensajesalerta("SIGA", "Archivo PDF obligatorio.", "error", "dark");
			validar = false;
		}
		
		valePDFForm.append("Usr_Inser", Usr_Inser);
		valePDFForm.append("valePDF", valePDF);
		valePDFForm.append("vrdNumEmpleado", vrdNumEmpleado);
		valePDFForm.append("vrdNumEmpleadoBaja", vrdNumEmpleadoBaja);
		valePDFForm.append("vrdId_Vale_Resguardo", 	vrdId_Vale_Resguardo);
		valePDFForm.append("accion", 2);
		...
		if(validar){
				...
				contentType: false,		
				beforeSend: function(){
					$('#subirEdcPdf').attr('disabled',true);
				},
				success: function(response){
					console.log(response);
					$('#modalSubirEDC').modal('hide');
						mensajesalerta("SIGA", "Se actualizo de manera adecuada el vale en EDC.", "success", "dark");
				},
				error: function(response){
					$('#subirEdcPdf').attr('disabled',false);
					mensajesalerta("SIGA", response, "error", "dark");
				}
			});
...
//==============================================================================================================================================================================================================
	...
	function subirValeEdc(Id_Vale_Resguardo, numEmpleado, nombreEmpleado){
		$('#modalSubirEDC').modal('show');
		$('#vrdNumEmpleado').html(numEmpleado);
		$('#vrdNombreEmpleado').html(nombreEmpleado);
		$('#vrdId_Vale_Resguardo').html(Id_Vale_Resguardo);	
		$('#pdfEdc').val('');
		$('#subirEdcPdf').attr('disabled',false);
	}
...
//==============================================================================================================================================================================================================
	...
	function abrirValeEdc(numEmpleado){
		window.open("https://apps2.hospitalsatelite.com/siga/Archivos/Archivos-VRD/"+numEmpleado+'.pdf', '_blank', 'location=yes', 'clearcache=yes');
	}
