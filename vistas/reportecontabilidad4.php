			...
			<button type="button" class="btn chs" id="btnBuscar">Buscar</button>
                    ...
                    <thead>
                      <tr>
						...
						<th style="<?php echo $style_size_table;?>">FACTOR B-10</th>
<th style="<?php echo $style_size_table;?>">MOI ACTUALIZADO B-10</th>
<th style="<?php echo $style_size_table;?>">ACTUALIZACIÓN MOI DEL PERIODO</th>
<th style="<?php echo $style_size_table;?>">EFECTO B-10 MOI DEL MES (A LA PÓLIZA)</th>
<th style="<?php echo $style_size_table;?>">TASA CONTABLE</th>
<th style="<?php echo $style_size_table;?>">DEPRECIACIÓN ANUAL ACTUALIZADA</th>
<th style="<?php echo $style_size_table;?>">DEPRECIACIÓN MENSUAL ACTUALIZADA</th>
<th style="<?php echo $style_size_table;?>">MESES DE DEPRECIACIÓN</th>
<th style="<?php echo $style_size_table;?>">DEPRECIACIÓN DEL PERIODO ACTUALIZADA</th>
<th style="<?php echo $style_size_table;?>">DEPRECIACIÓN DEL PERIODO HISTÓRICA</th>
<th style="<?php echo $style_size_table;?>">EFECTO B-10 DEPRECIACIÓN DEL PERIODO</th>
<th style="<?php echo $style_size_table;?>">EFECTO B-10 DEPRECIACIÓN DEL MES (A LA PÓLIZA)</th>
                    ...
                    <tbody>
					 ...
					 { 
                      ...
                      <tr>
						...
						<td style="<?php echo $style_size_table;?>">$<?php echo number_format($aniosArr[0]["FactorAjuste"]+1,4)?></td>
						<td style="<?php echo $style_size_table;?>">$<?php echo number_format($aniosArr[0]["MOIActualizadoB10"],4) ?></td>
						<td style="<?php echo $style_size_table;?>">$<?php echo number_format($aniosArr[0]["ActMOIPeriodoB10"],4) ?></td>
						<td style="<?php echo $style_size_table;?>">$<?php echo number_format($aniosArr[0]["EfectoB10"],4) ?></td>
						<td style="<?php echo $style_size_table;?>">$<?php echo number_format($aniosArr[0]["PorcentajeContable"],4) ?></td>
						<td style="<?php echo $style_size_table;?>">$<?php echo number_format($aniosArr[0]["DepAnualActB10"],4) ?></td>
						<td style="<?php echo $style_size_table;?>">$<?php echo number_format($aniosArr[0]["DepMenActB10"],4) ?></td>
						<td style="<?php echo $style_size_table;?>">$<?php echo number_format($aniosArr[0]["mescalculo"],4) ?></td>
						<td style="<?php echo $style_size_table;?>">$<?php echo number_format($aniosArr[0]["DepPerActB10"],4) ?></td>
						<td style="<?php echo $style_size_table;?>">$<?php echo number_format($aniosArr[0]["DepPeriodoAct"],4) ?></td>
						<td style="<?php echo $style_size_table;?>">$<?php echo number_format($aniosArr[0]["EfectoB10Dep"],4) ?></td>
						<td style="<?php echo $style_size_table;?>">$<?php echo number_format($aniosArr[0]["EfectoB10Mes"],4) ?></td>
					  ...
					  <tr>
						...
						<td style="<?php echo $style_size_table;?>">$<?php echo number_format($hijosArr[0]["FactorAjuste"]+1,4)?></td>
						<td style="<?php echo $style_size_table;?>">$<?php echo number_format($hijosArr[0]["MOIActualizadoB10"],4) ?></td>
						<td style="<?php echo $style_size_table;?>">$<?php echo number_format($hijosArr[0]["ActMOIPeriodoB10"],4) ?></td>
						<td style="<?php echo $style_size_table;?>">$<?php echo number_format($hijosArr[0]["EfectoB10"],4) ?></td>
						<td style="<?php echo $style_size_table;?>">$<?php echo number_format($hijosArr[0]["PorcentajeContable"],4) ?></td>
						<td style="<?php echo $style_size_table;?>">$<?php echo number_format($hijosArr[0]["DepAnualActB10"],4) ?></td>
						<td style="<?php echo $style_size_table;?>">$<?php echo number_format($hijosArr[0]["DepMenActB10"],4) ?></td>
						<td style="<?php echo $style_size_table;?>">$<?php echo number_format($hijosArr[0]["mescalculo"],4) ?></td>
						<td style="<?php echo $style_size_table;?>">$<?php echo number_format($hijosArr[0]["DepPerActB10"],4) ?></td>
						<td style="<?php echo $style_size_table;?>">$<?php echo number_format($hijosArr[0]["DepPeriodoAct"],4) ?></td>
						<td style="<?php echo $style_size_table;?>">$<?php echo number_format($hijosArr[0]["EfectoB10Dep"],4) ?></td>
						<td style="<?php echo $style_size_table;?>">$<?php echo number_format($hijosArr[0]["EfectoB10Mes"],4) ?></td>
...
<script>
 ...
 $("#btnBuscar").click(function(e){
	 //e.preventDefault();
	 if ($("#cmbAnual").val() == 0)
	 loadOptionBandejas('reportecontabilidad4.php?Id_Menu=5&Id_Submenu=7&Anio='+$("#cmbAnioFiltro").val()+'&Anual='+$("#cmbAnual").val()+'&INPCPeriodo='+$("#cmbINPC").val(),'contenedorprincipalactivofijo','3016'); 
	 else
	 loadOptionBandejas('reportecontabilidad4.php?Id_Menu=5&Id_Submenu=7&Anio='+$("#cmbAnioFiltro").val()+'&Anual='+$("#cmbAnual").val()+'&Mes='+$("#cmbMesFiltro").val()+'&INPCPeriodo='+$("#cmbINPC").val(),'contenedorprincipalactivofijo','3016'); 
