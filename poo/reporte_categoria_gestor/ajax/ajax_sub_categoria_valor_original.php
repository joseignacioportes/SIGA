...
if(isset($_POST['Id_Subcategoria']) && $_POST['Id_Subcategoria'] !==''){
...
$ticket_reasignacion_sub_categoria_array=["<option disabled selected>Sección</option>"];
    ...
    for ($i=0; $i < count($ticket_reasignacion_sub_categoria_res) ; $i++) {    
        if($ticket_reasignacion_sub_categoria_res[$i]['Id_Subcategoria'] == $Id_Subcategoria){$selected="selected";}else{$selected="";}
