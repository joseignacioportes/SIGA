...
if($siga_solicitud_ticketsDto->getNombre_Ejecutante()!=""){
...
if($siga_solicitud_ticketsDto->getEstatus_Proceso()=="1" || $siga_solicitud_ticketsDto->getId_Solicitud_Anterior()!="" || ($siga_solicitud_ticketsDto->getId_Medio()=='4' && $siga_solicitud_ticketsDto->getEstatus_Proceso()=="2" && $siga_solicitud_ticketsDto->getAsist_Especial()=="")){
$sql.=",Fech_Solicitud";
}
...
if($siga_solicitud_ticketsDto->getEmpresa_Ext()!=""){
$sql.=",Empresa_Ext";
}
if($siga_solicitud_ticketsDto->getNombre_Completo_Ext()!=""){
$sql.=",Nombre_Completo_Ext";
}
if($siga_solicitud_ticketsDto->getTelefono_Ext()!=""){
$sql.=",Telefono_Ext";
}
if($siga_solicitud_ticketsDto->getCorreo_Ext()!=""){
$sql.=",Correo_Ext";
}
$sql.=") VALUES(";
$sql.="'".$Idmaximo."'";
...
if($siga_solicitud_ticketsDto->getNombre_Ejecutante()!=""){
$sql.="'".$siga_solicitud_ticketsDto->getNombre_Ejecutante()."'";
$sql.=",";
}
if($siga_solicitud_ticketsDto->getId_Gestor()!=""){
...
if($siga_solicitud_ticketsDto->getId_Cirugia()!=""){
$sql.=",";
$sql.=$siga_solicitud_ticketsDto->getId_Cirugia();
}
if($siga_solicitud_ticketsDto->getEmpresa_Ext()!=""){
$sql.=",";
$sql.="'".$siga_solicitud_ticketsDto->getEmpresa_Ext()."'";
}
if($siga_solicitud_ticketsDto->getNombre_Completo_Ext()!=""){
$sql.=",";
$sql.="'".$siga_solicitud_ticketsDto->getNombre_Completo_Ext()."'";
}
if($siga_solicitud_ticketsDto->getTelefono_Ext()!=""){
$sql.=",";
$sql.="'".$siga_solicitud_ticketsDto->getTelefono_Ext()."'";
}
if($siga_solicitud_ticketsDto->getCorreo_Ext()!=""){
$sql.=",";
$sql.="'".$siga_solicitud_ticketsDto->getCorreo_Ext()."'";
}
$sql.=")";
//
...
if(($siga_solicitud_ticketsDto->getAsist_Especial()!="") ||($siga_solicitud_ticketsDto->getId_Usuario()!="") ||($siga_solicitud_ticketsDto->getId_Area()!="") ||($siga_solicitud_ticketsDto->getId_Medio()!="") ||($siga_solicitud_ticketsDto->getSeccion()!="") ||($siga_solicitud_ticketsDto->getTitulo()!="") ||($siga_solicitud_ticketsDto->getId_Actividad()!="") ||($siga_solicitud_ticketsDto->getId_Det_Actividad()!="") ||($siga_solicitud_ticketsDto->getDesc_Motivo_Reporte()!="") ||($siga_solicitud_ticketsDto->getPrioridad()!="") ||($siga_solicitud_ticketsDto->getUrl_archivo()!="") ||($siga_solicitud_ticketsDto->getArchivo_Binario()!="") ||($siga_solicitud_ticketsDto->getFech_Inser()!="") ||($siga_solicitud_ticketsDto->getUsr_Inser()!="") ||($siga_solicitud_ticketsDto->getFech_Mod()!="") ||($siga_solicitud_ticketsDto->getUsr_Mod()!="") ||($siga_solicitud_ticketsDto->getEstatus_Reg()!="") ||($siga_solicitud_ticketsDto->getEstatus_Proceso()!="") ||($siga_solicitud_ticketsDto->getLo_Realiza()!="") ||($siga_solicitud_ticketsDto->getId_Activo()!="") ||($siga_solicitud_ticketsDto->getId_Categoria()!="") ||($siga_solicitud_ticketsDto->getId_Subcategoria()!="") ||($siga_solicitud_ticketsDto->getNombre_Ejecutante()!="") ||($siga_solicitud_ticketsDto->getId_Gestor()!="") ||($siga_solicitud_ticketsDto->getId_Gestor_Reasignado()!="") ||($siga_solicitud_ticketsDto->getNombre_Gestor()!="") ||($siga_solicitud_ticketsDto->getTituloCierre()!="") ||($siga_solicitud_ticketsDto->getComentarioCierre()!="") || ($siga_solicitud_ticketsDto->getComentarioCierreGestor()!="") ||($siga_solicitud_ticketsDto->getId_Motivo_Aparente()!="") ||($siga_solicitud_ticketsDto->getId_Motivo_Real()!="") ||($siga_solicitud_ticketsDto->getId_Est_Equipo()!="") ||($siga_solicitud_ticketsDto->getFech_Solicitud()!="") ||($siga_solicitud_ticketsDto->getFech_Seguimiento()!="") ||($siga_solicitud_ticketsDto->getFech_Espera_Cierre()!="") ||($siga_solicitud_ticketsDto->getFech_Cierre()!="") ){
$sql.=",";
}
}
if($siga_solicitud_ticketsDto->getAsist_Especial()!=""){
...
if(($siga_solicitud_ticketsDto->getId_Subcategoria()!="") ||($siga_solicitud_ticketsDto->getNombre_Ejecutante()!="") ||($siga_solicitud_ticketsDto->getId_Gestor()!="") ||($siga_solicitud_ticketsDto->getId_Gestor_Reasignado()!="") ||($siga_solicitud_ticketsDto->getNombre_Gestor()!="") ||($siga_solicitud_ticketsDto->getTituloCierre()!="") ||($siga_solicitud_ticketsDto->getComentarioCierre()!="") || ($siga_solicitud_ticketsDto->getComentarioCierreGestor()!="") ||($siga_solicitud_ticketsDto->getId_Motivo_Aparente()!="") ||($siga_solicitud_ticketsDto->getId_Motivo_Real()!="") ||($siga_solicitud_ticketsDto->getId_Est_Equipo()!="") ||($siga_solicitud_ticketsDto->getFech_Solicitud()!="") ||($siga_solicitud_ticketsDto->getFech_Seguimiento()!="") ||($siga_solicitud_ticketsDto->getFech_Espera_Cierre()!="") ||($siga_solicitud_ticketsDto->getFech_Cierre()!="") ){
$sql.=",";
}
}
if($siga_solicitud_ticketsDto->getId_Subcategoria()!=""){
...
if($siga_solicitud_ticketsDto->getNombre_Ejecutante()!=""){
$sql.="Nombre_Ejecutante='".$siga_solicitud_ticketsDto->getNombre_Ejecutante()."'";
...
if(($siga_solicitud_ticketsDto->getId_Gestor_Reasignado()!="") ||($siga_solicitud_ticketsDto->getNombre_Gestor()!="") ||($siga_solicitud_ticketsDto->getTituloCierre()!="") ||($siga_solicitud_ticketsDto->getComentarioCierre()!="") || ($siga_solicitud_ticketsDto->getComentarioCierreGestor()!="") ||($siga_solicitud_ticketsDto->getId_Motivo_Aparente()!="") ||($siga_solicitud_ticketsDto->getId_Motivo_Real()!="") ||($siga_solicitud_ticketsDto->getId_Est_Equipo()!="") ||($siga_solicitud_ticketsDto->getFech_Solicitud()!="") ||($siga_solicitud_ticketsDto->getFech_Seguimiento()!="") ||($siga_solicitud_ticketsDto->getFech_Espera_Cierre()!="") ||($siga_solicitud_ticketsDto->getFech_Cierre()!="") ){
$sql.=",";
}
}
if($siga_solicitud_ticketsDto->getId_Gestor_Reasignado()!=""){
$sql.="Id_Gestor_Reasignado='".$siga_solicitud_ticketsDto->getId_Gestor_Reasignado()."'";
if(($siga_solicitud_ticketsDto->getNombre_Gestor()!="") ||($siga_solicitud_ticketsDto->getTituloCierre()!="") ||($siga_solicitud_ticketsDto->getComentarioCierre()!="") || ($siga_solicitud_ticketsDto->getComentarioCierreGestor()!="") ||($siga_solicitud_ticketsDto->getId_Motivo_Aparente()!="") ||($siga_solicitud_ticketsDto->getId_Motivo_Real()!="") ||($siga_solicitud_ticketsDto->getId_Est_Equipo()!="") ||($siga_solicitud_ticketsDto->getFech_Solicitud()!="") ||($siga_solicitud_ticketsDto->getFech_Seguimiento()!="") ||($siga_solicitud_ticketsDto->getFech_Espera_Cierre()!="") ||($siga_solicitud_ticketsDto->getFech_Cierre()!="") ){
$sql.=",";
}
}
if($siga_solicitud_ticketsDto->getNombre_Gestor()!=""){
$sql.="Nombre_Gestor='".$siga_solicitud_ticketsDto->getNombre_Gestor()."'";
if(($siga_solicitud_ticketsDto->getTituloCierre()!="") ||($siga_solicitud_ticketsDto->getComentarioCierre()!="") || ($siga_solicitud_ticketsDto->getComentarioCierreGestor()!="") ||($siga_solicitud_ticketsDto->getId_Motivo_Aparente()!="") ||($siga_solicitud_ticketsDto->getId_Motivo_Real()!="") ||($siga_solicitud_ticketsDto->getId_Est_Equipo()!="") ||($siga_solicitud_ticketsDto->getFech_Solicitud()!="") ||($siga_solicitud_ticketsDto->getFech_Seguimiento()!="") ||($siga_solicitud_ticketsDto->getFech_Espera_Cierre()!="") ||($siga_solicitud_ticketsDto->getFech_Cierre()!="") ){
$sql.=",";
}
}
if($siga_solicitud_ticketsDto->getTituloCierre()!=""){
$sql.="TituloCierre='".$siga_solicitud_ticketsDto->getTituloCierre()."'";
if(($siga_solicitud_ticketsDto->getComentarioCierre()!="") || ($siga_solicitud_ticketsDto->getComentarioCierreGestor()!="") ||($siga_solicitud_ticketsDto->getId_Motivo_Aparente()!="") ||($siga_solicitud_ticketsDto->getId_Motivo_Real()!="") ||($siga_solicitud_ticketsDto->getId_Est_Equipo()!="") ||($siga_solicitud_ticketsDto->getFech_Solicitud()!="") ||($siga_solicitud_ticketsDto->getFech_Seguimiento()!="") ||($siga_solicitud_ticketsDto->getFech_Espera_Cierre()!="") ||($siga_solicitud_ticketsDto->getFech_Cierre()!="") ){
$sql.=",";
}
}
if($siga_solicitud_ticketsDto->getComentarioCierre()!=""){
$sql.="ComentarioCierre='".$siga_solicitud_ticketsDto->getComentarioCierre()."'";
if(($siga_solicitud_ticketsDto->getComentarioCierreGestor()!="") || ($siga_solicitud_ticketsDto->getId_Motivo_Aparente()!="") ||($siga_solicitud_ticketsDto->getId_Motivo_Real()!="") ||($siga_solicitud_ticketsDto->getId_Est_Equipo()!="") ||($siga_solicitud_ticketsDto->getFech_Solicitud()!="") ||($siga_solicitud_ticketsDto->getFech_Seguimiento()!="") ||($siga_solicitud_ticketsDto->getFech_Espera_Cierre()!="") ||($siga_solicitud_ticketsDto->getFech_Cierre()!="") ){
$sql.=",";
}
}
if($siga_solicitud_ticketsDto->getComentarioCierreGestor()!=""){
$sql.="ComentarioCierreGestor='".$siga_solicitud_ticketsDto->getComentarioCierreGestor()."'";
...
if($siga_solicitud_ticketsDto->getEstatus_Proceso()=="3"){
	...
	if($siga_solicitud_ticketsDto->getUsr_Mod()!="" || $siga_solicitud_ticketsDto->getUsr_Inser()!=""){
		if($siga_solicitud_ticketsDto->getUsr_Mod()!=""){
			$sql.=",Gestor_Final_Cierre=".$siga_solicitud_ticketsDto->getUsr_Mod();
		}
		if($siga_solicitud_ticketsDto->getUsr_Inser()!=""){
			$sql.=",Gestor_Final_Cierre=".$siga_solicitud_ticketsDto->getUsr_Inser();
		}
	}else{
		$sql.=",Gestor_Final_Cierre=(select top 1 Id_Gestor from siga_solicitud_tickets where Id_Solicitud=".$siga_solicitud_ticketsDto->getId_Solicitud().")";
	}
}
...
$sql="		SELECT 	
				...
				S.Nombre_Ejecutante,
				S.Estatus_Recepcion,
				S.Comentarios_Recepcion,
				S.Id_Motivo_Rechazo,
				Estatus_Proceso Id_Estatus_Proceso,
				S.Asist_Especial,
				A.Marca,
				A.Modelo,
				A.NumSerie,
				...
				US.Desc_Ubic_Sec,
				Id_Solicitud,
				Id_Solicitud_Anterior,
				S.Id_Gestor_Reasignado,
				S.Id_Activo,
				Id_Usuario,
				S.Id_Area,
				Id_Actividad,
				...
				S.Modelo_Act_Ext,
				S.No_Serie_Act_Ext,
				S.Cantidad_Equ_Ext,S.Pre_Re_Procedimiento,
				S.Pre_Re_Fecha_Hora_Cirugia,
				S.Pre_Re_Quirofano,
				S.Pre_Re_Paciente,
				S.Pre_Re_Cirujano,
				S.Empresa_Ext,
				S.Nombre_Completo_Ext,
				S.Telefono_Ext,
				S.Correo_Ext,
				S.Pre_Registro_Ext,
				S.Observ_Pre_Reg_Ext,
				S.Id_Solicitud,
				(select top 1 Desc_Ubic_Prim from siga_cat_ubic_prim  UP where S.Id_Ubic_Prim=UP.Id_Ubic_Prim ) as Desc_Ubic_Prim_Act_Ext,
				S.Id_Ubic_Prim,
				(select top 1 Desc_Ubic_Sec from siga_cat_ubic_sec  US where S.Id_Ubic_Sec=US.Id_Ubic_Sec ) as Desc_Ubic_Sec_Act_Ext,
				S.Id_Ubic_Sec,
				...
				(select No_Usuario  from siga_usuarios A where S.Id_Usuario_Inicial=A.Id_Usuario) No_Usuario_Inicial,
				(select Nombre_Usuario  from siga_usuarios A where S.id_usuario_inicial=A.Id_Usuario) Nombre_Usuario_Inicial,
			...
			CASE 
				WHEN Gestor_Final_Cierre is null 
					THEN
						(SELECT TOP 1 No_Usuario+' '+Nombre_Usuario FROM siga_usuarios A WHERE S.Id_Gestor=A.Id_Usuario)
					ELSE 
						(SELECT No_Usuario+' '+Nombre_Usuario FROM siga_usuarios A WHERE S.Gestor_Final_Cierre=A.Id_Usuario)
			END as Gestor_Finaliza,
				(SELECT U.Nombre_Usuario FROM siga_usuarios U WHERE S.Id_Gestor=U.Id_Usuario) Gestor,
				TituloCierre,
				ComentarioCierre,
				ComentarioCierreGestor,
				S.Id_Medio,
				CM.Desc_Medio,
				S.Id_Motivo_Aparente,
				S.Id_Motivo_Real,
				S.Id_Est_Equipo,
				MA.Desc_Motivo_Aparente,
				MR.Desc_Motivo_Real,
				EE.Desc_Estatus,
				S.Lo_Realiza,
				S.Direccion_Ip_Sol,
				(SELECT (SELECT TOP 1 usuario_sistema_hospitalario FROM empleados_chs WHERE num_empleado=No_Usuario) FROM siga_usuarios A WHERE S.Id_Usuario=A.Id_Usuario) Usuario_Assist,
				(SELECT (SELECT TOP 1 usuario_sistema_hospitalario from empleados_chs where num_empleado=No_Usuario) FROM siga_usuarios A WHERE S.Id_Gestor=A.Id_Usuario) Gestor_Assist
				

		FROM siga_solicitud_tickets S (NOLOCK)
		LEFT JOIN siga_activos A (NOLOCK)				ON S.Id_Activo=A.Id_Activo 
		LEFT JOIN siga_cat_ubic_prim UP (NOLOCK)		ON S.Id_Ubic_Prim=UP.Id_Ubic_Prim 
		LEFT JOIN siga_cat_ubic_sec US (NOLOCK)			ON S.Id_Ubic_Sec=US.Id_Ubic_Sec 
		LEFT JOIN siga_cat_medios CM (NOLOCK)			ON S.Id_Medio=CM.Id_Medio 
		LEFT JOIN siga_cat_motivo_aparente MA (NOLOCK) 	ON S.Id_Motivo_Aparente=MA.Id_Motivo_Aparente
		LEFT JOIN siga_cat_motivo_real MR (NOLOCK)		ON S.Id_Motivo_Real=MR.Id_Motivo_Real
		LEFT JOIN siga_cat_estatus EE (NOLOCK)			ON S.Id_Est_Equipo=EE.Id_Estatus ";
...
if($siga_solicitud_ticketsDto->getEstatus_Reg()!=""){
	if($siga_solicitud_ticketsDto->getEstatus_Reg()!="3"){
		$sql.="S.Estatus_Reg <>'3'";
	}else{
		$sql.="S.Estatus_Reg in(1,2,3)";
	}
}
...
$Id_Activo="";
if($row["Id_Activo"]!=NULL){$Id_Activo=$row["Id_Activo"];}
...
$tmp[$contador]->setId_Activo($Id_Activo);
...
$tmp[$contador]->setComentarioCierreGestor($row["ComentarioCierreGestor"]);
...
$tmp[$contador]->setNombre_Ejecutante($row["Nombre_Ejecutante"]);
...
$tmp[$contador]->setGestor_Finaliza(rtrim(ltrim($row["Gestor_Finaliza"])));
...
$tmp[$contador]->setCantidad_Equ_Ext(rtrim(ltrim($row["Cantidad_Equ_Ext"])));
$tmp[$contador]->setPre_Re_Procedimiento(rtrim(ltrim($row["Pre_Re_Procedimiento"])));
$tmp[$contador]->setPre_Re_Fecha_Hora_Cirugia(rtrim(ltrim($row["Pre_Re_Fecha_Hora_Cirugia"])));
$tmp[$contador]->setPre_Re_Quirofano(rtrim(ltrim($row["Pre_Re_Quirofano"])));
$tmp[$contador]->setPre_Re_Paciente(rtrim(ltrim($row["Pre_Re_Paciente"])));
$tmp[$contador]->setPre_Re_Cirujano(rtrim(ltrim($row["Pre_Re_Cirujano"])));
$tmp[$contador]->setEmpresa_Ext(rtrim(ltrim($row["Empresa_Ext"])));
$tmp[$contador]->setNombre_Completo_Ext(rtrim(ltrim($row["Nombre_Completo_Ext"])));
$tmp[$contador]->setTelefono_Ext(rtrim(ltrim($row["Telefono_Ext"])));
$tmp[$contador]->setCorreo_Ext(rtrim(ltrim($row["Correo_Ext"])));
$tmp[$contador]->setPre_Registro_Ext(rtrim(ltrim($row["Pre_Registro_Ext"])));
$tmp[$contador]->setObserv_Pre_Reg_Ext(rtrim(ltrim($row["Observ_Pre_Reg_Ext"])));
$tmp[$contador]->setEstatus_Recepcion(rtrim(ltrim($row["Estatus_Recepcion"])));
$tmp[$contador]->setComentarios_Recepcion(rtrim(ltrim($row["Comentarios_Recepcion"])));
$tmp[$contador]->setId_Motivo_Rechazo(rtrim(ltrim($row["Id_Motivo_Rechazo"])));
...
$tmp[$contador]->setId_Cirugia(rtrim(ltrim($row["Id_Cirugia"])));
$tmp[$contador]->setUsuario_Assist(rtrim(ltrim($row["Usuario_Assist"])));
$tmp[$contador]->setGestor_Assist(rtrim(ltrim($row["Gestor_Assist"])));
$tmp[$contador]->setNo_Usuario_Inicial(rtrim(ltrim($row["No_Usuario_Inicial"])));
$tmp[$contador]->setNombre_Usuario_Inicial(rtrim(ltrim($row["Nombre_Usuario_Inicial"])));
...
public function llenarDataTable($draw,$columns,$order,$start,$length,$search,$Id_Estatus_Proceso,$siga_solicitud_ticketsDto,$Gestor_Solicitante, $Id_Seccion, $Tipo_Gestor, $Medio_de_Envio, $EsApp, $Todos_Tickets, $Tickets_SLA_Vencidos, $proveedor = null) {
        ...
        if ($order != ''AND count($order)> 0) {
			...
			if($aux["data"] !="function")
			{
				...
				if($order["column"]=="5"){
						$ordenamiento=' ORDER BY Estatus_Proceso  '.$order["dir"];
				}else{
						$ordenamiento=' ORDER BY Id_Solicitud asc ';
				}
		...
		if($Id_Estatus_Proceso=="4"){
			...
			if($search["value"]!=""){
				...
				$Busqueda.=" or ComentarioCierreGestor like '%".$search["value"]."%' ";
				$Busqueda.=" or Nom_Area like '%".$search["value"]."%' ";
				//Datos del Activo
				$Busqueda.=" or AF_BC_Ext like '%".$search["value"]."%' ";
				$Busqueda.=" or Nombre_Act_Ext like '%".$search["value"]."%' ";
		...
		if (!$this->_proveedor->error() AND $this->_proveedor->rows($this->_proveedor->stmt) > 0) {
          ...
          "Id_Usuario" => $row["Id_Usuario"],
			...
			$this->_proveedor->execute("select COUNT(*) AS total from ( SELECT 
										ST.Nombre_Ejecutante,
										ST.AF_BC_Ext, ST.Iniciar_SLA_Juridico, FORMAT(ST.Fecha_Inicio_SLA_Juridico,'dd/MM/yyyy hh:mm:ss') as Fecha_Inicio_SLA_Juridico, ST.Usr_Inicia_SLA_Juridico, ST.Nombre_Act_Ext, ST.Marca_Act_Ext, ST.Modelo_Act_Ext, ST.No_Serie_Act_Ext, UP.Desc_Ubic_Prim,US.Desc_Ubic_Sec, 
										case when ST.Id_Activo is not null then 
											(select top 1 Desc_Estatus from siga_cat_estatus where siga_cat_estatus.Id_Estatus=(select Id_Situacion_Activo from siga_activos ACT where ST.Id_Activo=ACT.Id_Activo)) 
										else
											(select top 1 Desc_Estatus from siga_cat_estatus where siga_cat_estatus.Id_Estatus=ST.Id_Est_Equipo) 
										...
										, FORMAT(ST.Fech_Seguimiento,'dd/MM/yyyy hh:mm:ss') as Fecha_Seguimiento,FORMAT(ST.Fech_Espera_Cierre,'dd/MM/yyyy hh:mm:ss') as Fecha_Esp_Cierre, FORMAT(ST.Fech_Cierre,'dd/MM/yyyy hh:mm:ss') as Fecha_Cierre, ST.ComentarioCierre, ST.ComentarioCierreGestor
										,(select P.Desc_Proceso from siga_cat_ticket_proceso P where P.Id_Estatus_Proceso=ST.Estatus_Proceso) Estatus_Proceso
										FROM siga_solicitud_tickets  ST 
										left join siga_cat_ticket_categoria SCMR on ST.Id_Categoria=SCMR.Id_Categoria 
										left join siga_cat_ticket_subcategoria SCTS on ST.Id_Subcategoria=SCTS.Id_Subcategoria 
										...
										left join siga_cat_ubic_sec US on ST.Id_Ubic_Sec=US.Id_Ubic_Sec 
										left join siga_usuarios Usr on ST.Id_Gestor_Reasignado=Usr.Id_Usuario 
										where ST.Estatus_Reg <> '3' ".$Tickets_SLA_Vencidos." and ".$Id_Usuario.$Id_Gestor.$Seccion.$Area.$Id_Categoria." Id_Solicitud LIKE '%%' ". "".$filtro.$Cerrados_por_mes." ) 
										siga_solicitud_tickets ".$Busqueda);
