<?php
 class Siga_cat_claseDTO {
    ...
    public function getDesc_Clase(){
        return $this->Desc_Clase;
    }
    public function setDesc_Clase($Desc_Clase){
    ...
    public function toString(){
        return array("Id_Clase"=>$this->Id_Clase,
"Id_Area"=>$this->Id_Area,
"Desc_Clase"=>$this->Desc_Clase,
