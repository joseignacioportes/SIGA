<?php
 class Siga_cast_motivo_reubicacionDTO {
    private $Id_Motivo_reubicacion;
    private $Id_Area;
    private $Desc_Motivo_reubicacion;
    private $Fech_Inser;
    private $Usr_Inser;
    private $Fech_Mod;
    private $Usr_Mod;
    private $Estatus_Reg;
    public function getId_Motivo_reubicacion(){
        return $this->Id_Motivo_reubicacion;
    }
    public function setId_Motivo_reubicacion($Id_Motivo_reubicacion){
        $this->Id_Motivo_reubicacion=$Id_Motivo_reubicacion;
    }
    ...
    public function getDesc_Motivo_reubicacion(){
        return $this->Desc_Motivo_reubicacion;
    }
    public function setDesc_Motivo_reubicacion($Desc_Motivo_reubicacion){
        $this->Desc_Motivo_reubicacion=$Desc_Motivo_reubicacion;
    }
    ...
    public function toString(){
        return array("Id_Motivo_reubicacion"=>$this->Id_Motivo_reubicacion,
"Id_Area"=>$this->Id_Area,
"Desc_Motivo_reubicacion"=>$this->Desc_Motivo_reubicacion,
