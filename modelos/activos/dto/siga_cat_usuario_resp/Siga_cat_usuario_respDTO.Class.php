<?php
 class Siga_cat_usuario_respDTO {
    private $Id_Usuario_Resp;
    private $Id_Area;
    private $Desc_Usuario_Resp;
    private $Fech_Inser;
    private $Usr_Inser;
    private $Fech_Mod;
    private $Usr_Mod;
    ...
    public function getDesc_Usuario_Resp(){
        return $this->Desc_Usuario_Resp;
    }
    public function setDesc_Usuario_Resp($Desc_Usuario_Resp){
        $this->Desc_Usuario_Resp=$Desc_Usuario_Resp;
    }
    ...
    public function toString(){
        return array("Id_Usuario_Resp"=>$this->Id_Usuario_Resp,
"Id_Area"=>$this->Id_Area,
"Desc_Usuario_Resp"=>$this->Desc_Usuario_Resp,
