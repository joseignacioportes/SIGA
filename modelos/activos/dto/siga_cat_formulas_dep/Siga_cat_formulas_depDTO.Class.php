<?php
 class Siga_cat_formulas_depDTO {
    private $Id_Formulas_Dep;
    private $Id_Area;
    private $Desc_Formulas_Dep;
    private $Fech_Inser;
    private $Usr_Inser;
    private $Fech_Mod;
    private $Usr_Mod;
    private $Estatus_Reg;
    public function getId_Formulas_Dep(){
        return $this->Id_Formulas_Dep;
    }
    public function setId_Formulas_Dep($Id_Formulas_Dep){
        $this->Id_Formulas_Dep=$Id_Formulas_Dep;
    }
    ...
    public function getDesc_Formulas_Dep(){
        return $this->Desc_Formulas_Dep;
    }
    public function setDesc_Formulas_Dep($Desc_Formulas_Dep){
        $this->Desc_Formulas_Dep=$Desc_Formulas_Dep;
    }
    ...
    public function toString(){
        return array("Id_Formulas_Dep"=>$this->Id_Formulas_Dep,
"Id_Area"=>$this->Id_Area,
"Desc_Formulas_Dep"=>$this->Desc_Formulas_Dep,
