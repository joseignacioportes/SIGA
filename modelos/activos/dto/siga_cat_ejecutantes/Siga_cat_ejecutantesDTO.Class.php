<?php
 class Siga_cat_ejecutantesDTO {
    ...
    private $Usr_Mod;
    private $Estatus_Reg;
    public function getId_Ejecutante(){
        return $this->Id_Ejecutante;
    }
    public function setId_Ejecutante($Id_Ejecutante){
        $this->Id_Ejecutante=$Id_Ejecutante;
    }
    ...
    public function toString(){
        return array("Id_Ejecutante"=>$this->Id_Ejecutante,
