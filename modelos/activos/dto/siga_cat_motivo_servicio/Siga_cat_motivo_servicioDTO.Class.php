<?php
 class Siga_cat_motivo_servicioDTO {
    private $Id_Motivo_Servicio;
    private $Id_Area;
    private $Desc_Motivo_Servicio;
    private $Fech_Inser;
    private $Usr_Inser;
    private $Fech_Mod;
    private $Usr_Mod;
    private $Estatus_Reg;
    public function getId_Motivo_Servicio(){
        return $this->Id_Motivo_Servicio;
    }
    public function setId_Motivo_Servicio($Id_Motivo_Servicio){
        $this->Id_Motivo_Servicio=$Id_Motivo_Servicio;
    }
    ...
    public function getDesc_Motivo_Servicio(){
        return $this->Desc_Motivo_Servicio;
    }
    public function setDesc_Motivo_Servicio($Desc_Motivo_Servicio){
        $this->Desc_Motivo_Servicio=$Desc_Motivo_Servicio;
    }
    ...
    public function toString(){
        return array("Id_Motivo_Servicio"=>$this->Id_Motivo_Servicio,
"Id_Area"=>$this->Id_Area,
"Desc_Motivo_Servicio"=>$this->Desc_Motivo_Servicio,
