<?php
 class Siga_cat_propiedadDTO {
    private $Id_Propiedad;
    private $Id_Area;
    private $Desc_Propiedad;
    private $Fech_Inser;
    private $Usr_Inser;
    private $Fech_Mod;
    private $Usr_Mod;
    ...
    public function getDesc_Propiedad(){
        return $this->Desc_Propiedad;
    }
    public function setDesc_Propiedad($Desc_Propiedad){
    ...
    public function toString(){
        return array("Id_Propiedad"=>$this->Id_Propiedad,
"Id_Area"=>$this->Id_Area,
"Desc_Propiedad"=>$this->Desc_Propiedad,
