<?php
 class Siga_cat_aniosDTO {
    ...
    private $Usr_Mod;
    private $Estatus_Reg;
    public function getId_Anios(){
        return $this->Id_Anios;
    }
    public function setId_Anios($Id_Anios){
        $this->Id_Anios=$Id_Anios;
    }
    ...
    public function getDesc_Anios(){
        return $this->Desc_Anios;
    }
    public function setDesc_Anios($Desc_Anios){
        $this->Desc_Anios=$Desc_Anios;
    }
    ...
    public function toString(){
        return array("Id_Anios"=>$this->Id_Anios,
"Id_Area"=>$this->Id_Area,
"Desc_Anios"=>$this->Desc_Anios,
