<?php
 class Siga_cat_mesesDTO {
    ...
    private $Usr_Mod;
    private $Estatus_Reg;
    public function getId_Meses(){
        return $this->Id_Meses;
    }
    public function setId_Meses($Id_Meses){
        $this->Id_Meses=$Id_Meses;
    }
    ...
    public function getDesc_Meses(){
        return $this->Desc_Meses;
    }
    public function setDesc_Meses($Desc_Meses){
        $this->Desc_Meses=$Desc_Meses;
    }
    ...
    public function toString(){
        return array("Id_Meses"=>$this->Id_Meses,
"Id_Area"=>$this->Id_Area,
"Desc_Meses"=>$this->Desc_Meses,
