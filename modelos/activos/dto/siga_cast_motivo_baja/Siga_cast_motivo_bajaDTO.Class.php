<?php
 class Siga_cast_motivo_bajaDTO {
    private $Id_Motivo_baja;
    private $Id_Area;
    private $Desc_Motivo_baja;
    private $Fech_Inser;
    private $Usr_Inser;
    private $Fech_Mod;
    private $Usr_Mod;
    private $Estatus_Reg;
    public function getId_Motivo_baja(){
        return $this->Id_Motivo_baja;
    }
    public function setId_Motivo_baja($Id_Motivo_baja){
    ...
    public function getDesc_Motivo_baja(){
        return $this->Desc_Motivo_baja;
    }
    public function setDesc_Motivo_baja($Desc_Motivo_baja){
        $this->Desc_Motivo_baja=$Desc_Motivo_baja;
    }
    ...
    public function toString(){
        return array("Id_Motivo_baja"=>$this->Id_Motivo_baja,
"Id_Area"=>$this->Id_Area,
"Desc_Motivo_baja"=>$this->Desc_Motivo_baja,
