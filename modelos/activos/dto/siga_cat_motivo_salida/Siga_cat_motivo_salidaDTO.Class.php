<?php
 class Siga_cat_motivo_salidaDTO {
    private $Id_Motivo_Salida;
    private $Id_Area;
    private $Desc_Motivo_Alta;
    private $Fech_Inser;
    private $Usr_Inser;
    private $Fech_Mod;
    private $Usr_Mod;
    ...
    public function getDesc_Motivo_Alta(){
        return $this->Desc_Motivo_Alta;
    }
    public function setDesc_Motivo_Alta($Desc_Motivo_Alta){
        $this->Desc_Motivo_Alta=$Desc_Motivo_Alta;
    }
    ...
    public function toString(){
        return array("Id_Motivo_Salida"=>$this->Id_Motivo_Salida,
"Id_Area"=>$this->Id_Area,
"Desc_Motivo_Alta"=>$this->Desc_Motivo_Alta,
