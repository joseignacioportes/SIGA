...
//-------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        $idActividad = $rutinasClass->sigaRutinasActividad($idRutina,$siga_rutina_actividad,$siga_rutina_valor_referenciado,$siga_rutina_valor_medio,$siga_rutina_adjunto,$Id_Usuario);
